<div class="col-md-4">
    {!! Form::label('mood', ' mood', ['class' => 'col-form-label text-capitalize label-align']) !!}
    {!! Form::text('mood', null, ['class' => 'form-control', 'id' => 'mood']) !!}
    @error('mood')
 ...
 *', ['class' => 'col-form-label text-capitalize label-align']) !!}
    ...
    {{ Html::image(asset('storage/' . $module . '/' . @$row->image_new), null, ['class' =>'bg-dark','title' => @$row->image_new,
    'width' => '150px']) }}
    @endif
