                ...
                <div class="card border-light-subtle shadow-sm card-custom">
                    <div class="row g-0">
                        {{-- <div class="col-12 col-md-6">
                            <img class="img-fluid rounded-start w-100 h-100 img-fluid-custom" loading="lazy"
                                src="{{ asset('website/assets/images/logo-img-1.webp') }}"
                                ...
                                <div class="card-body p-3 p-md-4 p-xl-3">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <p class="text-center mt-4 mb-4">Or sign in with</p>
                                        </div>
                                    </div>
