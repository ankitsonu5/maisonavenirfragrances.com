            ...
            <div class="sliding-content d-flex">
                    ...
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img class="img-fluid"
                                    src="{{ asset('storage/product/' . $data->maine_image) }}" alt="Maison de l'Avenir">
                            </div>
                            <div class="swiper-slide"><img class="img-fluid"
                                    src="{{ asset('storage/product/' . $data->left_image) }}" alt="Maison de l'Avenir">
                            </div>
                            <div class="swiper-slide"><img class="img-fluid"
                                    src="{{ asset('storage/product/' . $data->right_up_image) }}"
                                    alt="Maison de l'Avenir">
                            </div>
                            <div class="swiper-slide"><img class="img-fluid"
                ...
                <div class="col-md-7 col-12 productinfo">
                    ...
                    <div class="container mt-5">
                        ...
                        <p class="product-subtitle">{{ $data->fragrance }}</p>
                        ...
                        <div class="product-description">
                            ...
                            <u class="show mx-1 text-light" id="showMoreBtn">Show More</u>
                        </div>
                        ...
                        <div class="fragrance-details-mobile">
                            ...
                            <div class="fragrance-item"
                                ...
                                data-image-active="{{ asset('website/assets/images/fragrance-details/8.png') }}  alt='fragrance-details' "
                                onclick="UpdateImage(this)">
                                <p class="fragrance-label">Base Note</p>
                                <img src="{{ asset('website/assets/images/fragrance-details/4.png') }}"
                                    alt='fragrance-details'" alt="Base Note" class="fragrance-image">
                                <p class="fragrance-description">{!! $data->basenote_title !!}</p>
                            </div>
                        </div>
