<x-app-layout :title="'Opulent Odyssey | Oriental Woody Fragrance - Maison de l Avenir'" :description="'Experience Opulent Odyssey&apos;s rich Oriental Woody blend with premium ingredients. Luxury unisex fragrance with exceptional longevity. Shop now.'">

    <!-- Video Section -->
    <div class="video-container ripple">
        <video id="bgVideo" autoplay muted>
            <source src="/website/scentopia/video/zenith/Opulent_Odyssey.mp4" type="video/mp4">
        </video>
    </div>
            ...
            <div class="product-descriptionsentopia ">
                ...
                <div class="row justify-content-between icon-grid">
                    <div class="col-md-4   mb-2 mb-md-0 col-12">
                        <img src="/website/scentopia/product/zenith/Opulent Odyssey.svg">
                    </div>
                    <div class="col-md-4  mb-5 mb-md-0 col-12">
                        <p>
                            Inspired by India's vibrant bazaars, the fragrance showcases notes of rose Damascena, Indian
                            oud, leather, and labdanum.
                        </p>
                        <div class="know-more">
                            <a href="https://www.maisonavenirfragrances.com/our-fragrance/detail/opulent-odyssey"
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    ...
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Weekend-Outing-674ee8d899888.png"
                            alt="Weekend Outing" class="icon-bubble">
                        <div><strong>Travel In Style</strong></div>
                        <small>Ideal For Joyful Moments</small>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="text-center px-3">
                        <p class="text-light">
                            <strong>Woody</strong> 13.89% |
                            <strong>Amber</strong> 12.50% |
                            <strong>Warm Spicy</strong> 11.81% |
                            <strong>Aromatic</strong> 11.11% |
                            <strong>Fresh Spicy</strong> 10.42% |
                            <strong>Leather</strong> 9.72% |
                            <strong>Citrus</strong> 9.03% |
                            <strong>Powdery</strong> 8.33% |
                            <strong>Balsamic</strong> 6.94% |
                            <strong>Smoky</strong> 6.25%
                        </p>
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            labels: [
                                ...
                                'Leather', 'Citrus', 'Powdery', 'Balsamic', 'Smoky'
                            ],
                            datasets: [{
                                ...
                                backgroundColor: [
                                    '#7b5b2a', '#c56c36', '#d63c1a', '#2d9b8f',
                                    '#a8e6a3', '#a3908c', '#f7f54a', '#eae3db',
                                    '#c0a98e', '#6e6050'
                                ],
