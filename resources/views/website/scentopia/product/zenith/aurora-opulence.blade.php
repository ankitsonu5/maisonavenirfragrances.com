<x-app-layout :title="'Aurora Opulence | Premium Fragrance - Maison de l Avenir'" :description="'Discover Aurora Opulence&apos;s sophisticated scent profile with natural essential oils. Premium unisex fragrance with exceptional longevity. Order today.'">

    <!-- Video Section -->
    <div class="video-container ripple">
        <video id="bgVideo" autoplay muted>
            <source src="/website/scentopia/video/zenith/Aurora_Opulence.mp4" type="video/mp4">
        </video>
    </div>
        ...
        <div class="container">
            <div class="parent-container">
                <div class="backbutton"> <a onclick="handleClick(event)"
                        href="{{ route('scentopia.product.zenith.index') }}" class="know-more-btn-scentopia ">
                        <div>Back</div>
                    </a></div>
            </div>
            <div class="product-descriptionsentopia ">
                ...
                <div class="row justify-content-between icon-grid">
                    <div class="col-md-4   mb-2 mb-md-0 col-12">
                        <img src="/website/scentopia/product/zenith/Aurora Opulence.svg">
                    </div>
                    <div class="col-md-4  mb-5 mb-md-0 col-12">
                        <p>
                            Experience the romantic allure of a sunrise with its enchanting blend of rose, Jasmine
                            Absolute, and sweet honeycomb.
                        </p>
                        <div class="know-more">
                            <a href="https://www.maisonavenirfragrances.com/our-fragrance/detail/aurora-opulence"
    ...
    <div class=" ripple secand-section ">
        ...
        <div class="container">
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/mood/Sensual-674e8f1fabb2a.png"
                            alt="Jasmine Absolute" class="icon-bubble">
                        <div><strong>Contains Jasmine Absolute</strong></div>
                        <small><span style="color:#cab651">Mood Impact:</span><br>Sensual And Elegant</small>
                    </div>
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/mood/Relaxed-674e904067978.png"
                            alt="Sweet Orange Oil" class="icon-bubble">
                        <div><strong>Contains Sweet Orange Oil</strong></div>
                        <small><span style="color:#cab651">Mood Impact:</span><br>Relaxing And Alluring</small>
                    </div>
                </div>
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Romantic-Evening-674ee8b1e0079.png"
                            alt="Coffee Date or Romantic Evening" class="icon-bubble">
                        <div><strong>Captivate With Grace</strong></div>
                        <small>Perfect For A Coffee Date Or A Romantic Evening</small>
                    </div>

                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Social-Gatherings-674ee99d03b54.png"
                            alt="Social Gatherings" class="icon-bubble">
                        <div><strong>Charm Everyone</strong></div>
                        <small>Ideal For Social Gatherings</small>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="text-center px-3">
                        <p class="text-light">
                            <strong>Citrus</strong> 13.89% |
                            <strong>Woody</strong> 12.50% |
                            <strong>Rose</strong> 11.81% |
                            <strong>Fresh Spicy</strong> 11.11% |
                            <strong>Powdery</strong> 10.42% |
                            <strong>Warm Spicy</strong> 9.72% |
                            <strong>Floral</strong> 9.03% |
                            <strong>Sweet</strong> 8.33% |
                            <strong>White floral</strong> 6.94% |
                            <strong>Yellow floral</strong> 6.25%
                        </p>
                ...
                <div class="col-md-4 d-flex  justify-content-center align-items-center">
                    <div class="gender-box">
                        ...
                        <img src="/website/scentopia/icone/uniseximage-3.png" alt="Unisex"
                            class="d-none d-md-block" />

                        <!-- Mobile ke liye: d-block (show by default), d-md-none (medium and above hide) -->
                        <img src="/website/scentopia/icone/uniseximage-3-mobile.png" alt="Unisex Mobile"
    ...
    @include('website.scentopia.product.zenith.productcaard')
            ...
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            labels: [
                                'Citrus', 'Woody', 'Rose', 'Fresh Spicy', 'Powdery',
                                'Warm Spicy', 'Floral', 'Sweet', 'White floral', 'Yellow floral'
                            ],
                            datasets: [{
                                label: 'Fragrance Notes',
                                data: [
                                    13.89, 12.50, 11.81, 11.11, 10.42,
                                    9.72, 9.03, 8.33, 6.94, 6.25
                                ],
                                backgroundColor: [
                                    '#f7f54a', '#7b5b2a', '#f06292', '#a8e6a3',
                                    '#eae3db', '#cd853f', '#f8bbd0', '#f4b9b6',
                                    '#f5f5f5', '#f9e76f'
                                ],
