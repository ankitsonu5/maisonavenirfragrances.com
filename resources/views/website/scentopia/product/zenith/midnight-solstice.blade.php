<x-app-layout :title="'Midnight Solstice | Zenith Collection
'" :description="'Experience Midnight Solstices mysterious fragrance in Scentopia. Unisex perfume with long-lasting performance.
'">

    <!-- Video Section -->
    <div class="video-container ripple">
        <video id="bgVideo" autoplay muted>
            <source src="/website/scentopia/video/zenith/Midnight_Solstice.mp4" type="video/mp4">
        </video>
    </div>
            ...
            <div class="product-descriptionsentopia ">
                ...
                <div class="row justify-content-between icon-grid">
                    <div class="col-md-4   mb-2 mb-md-0 col-12">
                        <img src="/website/scentopia/product/zenith/Midnight Solistice.svg">
                    </div>
                    <div class="col-md-4  mb-5 mb-md-0 col-12">
                        <p>
                            Inspired by moonlit dunes and starlit skies, the fragrance blends velvety magnolia, leather
                            oud, amber and Cambodian oud.
                        </p>
                        <div class="know-more">
                            <a href="https://www.maisonavenirfragrances.com/our-fragrance/detail/midnight-solstice"
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        ...
                        <small><span style="color:#cab651">Mood Impact:</span><br>Calming And Reassuring</small>
                    </div>
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/mood/Romantic-674e8fad36e55.png"
                            alt="Sandalwood Oil" class="icon-bubble">
                        <div><strong>Contains Sandalwood Oil</strong></div>
                        <small><span style="color:#cab651">Mood Impact:</span><br>Alluring And Grounding</small>
                    </div>
                </div>
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Romantic-Evening-674ee8b1e0079.png"
                            alt="Romantic Evening" class="icon-bubble">
                        <div><strong>Unveil Your Charisma</strong></div>
                        <small>Perfect For A Romantic Evening</small>
                    </div>

                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Personal-Celebration-674ee8fb03824.png"
                            alt="Personal Celebrations" class="icon-bubble">
                        <div><strong>Make Every Moment Special</strong></div>
                        <small>Perfect For Personal Celebrations</small>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="text-center px-3">
                        <p class="text-light">
                            <strong>Aromatic</strong> 13.89% |
                            <strong>Woody</strong> 12.50% |
                            <strong>Leather</strong> 11.81% |
                            <strong>Fresh Spicy</strong> 11.11% |
                            <strong>Warm Spicy</strong> 10.42% |
                            <strong>Amber</strong> 9.72% |
                            <strong>Fruity</strong> 9.03% |
                            <strong>Earthy</strong> 8.33% |
                            <strong>Citrus</strong> 7.64% |
                            <strong>Animalic</strong> 6.94%
                        </p>
            ...
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            labels: [
                                'Aromatic', 'Woody', 'Leather', 'Fresh Spicy', 'Warm Spicy',
                                'Amber', 'Fruity', 'Earthy', 'Citrus', 'Animalic'
                            ],
                            datasets: [{
                                label: 'Fragrance Notes',
                                data: [
                                    13.89, 12.50, 11.81, 11.11, 10.42,
                                    9.72, 9.03, 8.33, 7.64, 6.94
                                ],
                                backgroundColor: [
                                    '#2d9b8f', '#7b5b2a', '#a3908c', '#a8e6a3',
                                    '#d63c1a', '#c56c36', '#f08080', '#a49e8d',
                                    '#f7f54a', '#b79662'
                                ],
