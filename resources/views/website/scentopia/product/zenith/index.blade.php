<x-app-layout :title="'Zenith Collection | Interactive Scent Experience'" :description="'Immerse yourself in the Zenith collection via Scentopias interactive features for every fragrance.
'">
    <style>
        .home .div {
    ...
    <div class="container  my-4">
        <div class="row justify-content-between">
            ...
            <div class="col-md-4 col-12 order-2 order-md-1">
                <h1 class="page-heading">Experience our <br> Zenith Collection</h1>
            </div>
