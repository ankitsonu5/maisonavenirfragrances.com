<x-app-layout :title="'Midnight Solstice | Oriental Woody Scent - Maison de l Avenir'" :description="'Experience Midnight Solstice&apos;s mysterious Oriental Woody fragrance with natural oils. Premium unisex perfume with long-lasting performance.'">


    <!-- Video Section -->
    <div class="video-container ripple">
        <video id="bgVideo" autoplay muted>
            <source src="/website/scentopia/video/supernova/Majestic_Millenium.mp4" type="video/mp4">
        </video>
    </div>
        ...
        <div class="container">
            <div class="parent-container">
                <div class="backbutton"> <a onclick="handleClick(event)"
                        href="{{ route('scentopia.product.supernova.index') }}" class="know-more-btn-scentopia ">
                        <div>Back</div>
                    </a></div>
            </div>
            <div class="product-descriptionsentopia ">
                ...
                <div class="row justify-content-between icon-grid">
                    <div class="col-md-4   mb-2 mb-md-0 col-12">
                        <img src="/website/scentopia/product/supernova/Majestic Millenium.svg">
                    </div>
                    <div class="col-md-4  mb-5 mb-md-0 col-12">
                        <p>
                            Each spritz captures the essence of adventure, featuring the invigorating freshness of
                            lemon, petit grain, bitter almond, jasmine, and oud.
                        </p>
                        <div class="know-more">
                            <a href="https://www.maisonavenirfragrances.com/our-fragrance/detail/majestic-millenium"
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/mood/Energetic-674e8f399e8c2.png"
                            alt="Eugenol Oil" class="icon-bubble">
                        <div><strong>Contains Eugenol Oil</strong></div>
                        <small>
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Personal-Celebration-674ee8fb03824.png"
                            alt="Outdoor Activities" class="icon-bubble">
                        <div><strong>Embrace Freshness</strong></div>
                        <small>Perfect For Outdoor Activities</small>
                    </div>

                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Formal-Event-674ee852435ec.png"
                            alt="Corporate Events" class="icon-bubble">
                        <div><strong>Command Attention</strong></div>
                        <small>Great For Corporate Events</small>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="text-center px-3">
                        <p class="text-light">
                            <strong>Aromatic</strong> 13.70% |
                            <strong>Fresh Spicy</strong> 12.33% |
                            <strong>Woody</strong> 11.64% |
                            <strong>Warm Spicy</strong> 10.96% |
                            <strong>Herbal</strong> 10.27% |
                            <strong>Musky</strong> 9.59% |
                            <strong>Citrus</strong> 8.90% |
                            <strong>Powdery</strong> 8.22% |
                            <strong>Green</strong> 7.53% |
                            <strong>Soft Spicy</strong> 6.85%
                        </p>
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            labels: [
                                ...
                                'Musky', 'Citrus', 'Powdery', 'Green', 'Soft Spicy'
                            ],
                            datasets: [{
                                label: 'Fragrance Notes',
                                data: [
                                    13.70, 12.33, 11.64, 10.96, 10.27,
                                    9.59, 8.90, 8.22, 7.53, 6.85
                                ],
                                backgroundColor: [
                                    '#2d9b8f', '#a8e6a3', '#7b5b2a', '#d63c1a',
                                    '#a8c3a0', '#eae9f2', '#f7f54a', '#eae3db',
                                    '#3cad3a', '#e89f89'
                                ],
