<x-app-layout :title="'Avenir Triumph | Premium Fragrance - Maison de l Avenir'" :description="'Experience Avenir Triumph&apos;s sophisticated blend with natural essential oils. Premium unisex fragrance offering exceptional longevity. Order today.'">


    <!-- Video Section -->
    <div class="video-container ripple">
        <video id="bgVideo" autoplay muted>
            <source src="/website/scentopia/video/supernova/Avenir_Triumph.mp4" type="video/mp4">
        </video>
    </div>
            ...
            <div class="product-descriptionsentopia ">
                ...
                <div class="row justify-content-between icon-grid">
                    ...
                    <div class="col-md-4   mb-2 mb-md-0 col-12">
                        <img src="/website/scentopia/product/supernova/Avenir Triumph.svg">

                    </div>
                    <div class="col-md-4  mb-5 mb-md-0 col-12">
                        <p>
                            An olfactory testament to the human spirit, this scent bursts with mandarin orange and
                            bergamot, woven with cinnamon and leather.
                        </p>
                        <div class="know-more">
                            <a href="https://www.maisonavenirfragrances.com/our-fragrance/detail/avenir-triumph"
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/mood/Playful-674e905e17b46.png"
                    ...
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/mood/Energetic-674e8f399e8c2.png"
                            alt="Jasmine Sambac" class="icon-bubble">
                        <div><strong>Contains Jasmine Sambac</strong></div>
                        <small>
                            <span style="color:#cab651">Mood Impact:</span><br>
                            Empowering And Self-Assured
                        </small>
                    </div>
                </div>
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Work-674ee93e4d3cc.png"
                    ...
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Personal-Celebration-674ee8fb03824.png"
                            alt="Fitness Activities" class="icon-bubble">
                        <div><strong>Embrace Your Drive</strong></div>
                        <small>Perfect For Fitness Activities</small>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="text-center px-3">
                        <p class="text-light">
                            <strong>Warm Spicy</strong> 12.90% |
                            <strong>Citrus</strong> 12.26% |
                            <strong>Fresh Spicy</strong> 11.61% |
                            <strong>Aromatic</strong> 10.97% |
                            <strong>Green</strong> 10.32% |
                            <strong>Woody</strong> 9.68% |
                            <strong>Powdery</strong> 9.03% |
                            <strong>White floral</strong> 8.39% |
                            <strong>Cinnamon</strong> 7.74% |
                            <strong>Fresh</strong> 7.10%
                        </p>
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            labels: [
                                ...
                                'Woody', 'Powdery', 'White floral', 'Cinnamon', 'Fresh'
                            ],
                            datasets: [{
                                ...
                                backgroundColor: [
                                    '#d63c1a', '#f7f54a', '#a8e6a3', '#2d9b8f',
                                    '#3cad3a', '#7b5b2a', '#eae3db', '#f5f5f5',
                                    '#cd853f', '#c1ece4'
                                ],
