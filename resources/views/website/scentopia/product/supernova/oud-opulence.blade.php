<x-app-layout :title="'Oud Opulence | Luxury Fragrance - Maison de l Avenir'" :description="'Discover Oud Opulence&apos;s rich, luxurious scent with precious oud and natural oils. Premium unisex fragrance with exceptional longevity. Shop now.'">


    <!-- Video Section -->
    <div class="video-container ripple">
        <video id="bgVideo" autoplay muted>
            <source src="/website/scentopia/video/supernova/Oud_opulence.mp4" type="video/mp4">
        </video>
    </div>
            ...
            <div class="product-descriptionsentopia ">
                ...
                <div class="row justify-content-between icon-grid">
                    <div class="col-md-4   mb-2 mb-md-0 col-12">
                        <img src="/website/scentopia/product/supernova/Oud Opulence.svg">
                    </div>
                    <div class="col-md-4  mb-5 mb-md-0 col-12">
                        <p>
                            Experience the grandeur and sophistication of Ara bian culture, as this fragrance
                            intertwines saffron, oud, and leather in a majestic blend.
                        </p>
                        <div class="know-more">
                            <a href="https://www.maisonavenirfragrances.com/our-fragrance/detail/oud-opulence"
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Social-Gatherings-674ee99d03b54.png"
                            alt="Fine Dining or Weddings" class="icon-bubble">
                        <div><strong>Make A Lasting Impression</strong></div>
                        <small>Perfect For Fine Dining Or Weddings</small>
                    </div>
                    ...
                    <div class="content-block">
                        ...
                        <div><strong>Embrace Luxury</strong></div>
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="text-center px-3">
                        <p class="text-light">
                            <strong>Woody</strong> 13.70% |
                            <strong>Fresh Spicy</strong> 12.33% |
                            <strong>Amber</strong> 11.64% |
                            <strong>Balsamic</strong> 10.96% |
                            <strong>Warm Spicy</strong> 10.27% |
                            <strong>Aromatic</strong> 9.59% |
                            <strong>Powdery</strong> 8.90% |
                            <strong>Earthy</strong> 8.22% |
                            <strong>Rose</strong> 7.53% |
                            <strong>Leather</strong> 6.85%
                        </p>
            ...
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            labels: [
                                'Woody', 'Fresh Spicy', 'Amber', 'Balsamic', 'Warm Spicy',
                                'Aromatic', 'Powdery', 'Earthy', 'Rose', 'Leather'
                            ],
                            datasets: [{
                                ...
                                backgroundColor: [
                                    '#7b5b2a', '#a8e6a3', '#c56c36', '#c0a98e',
                                    '#d63c1a', '#2d9b8f', '#eae3db', '#a49e8d',
                                    '#f48fb1', '#a3908c'
                                ],
