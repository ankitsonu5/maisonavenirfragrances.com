<x-app-layout :title="'Nebula Nectar | Aromatic Woody Cologne - Maison de l Avenir'" :description="'Experience Nebula Nectar&apos;s refreshing Aromatic Woody scent with mint, lavender & amber. Premium 48-hour unisex fragrance made with natural oils.'">


    <!-- Video Section -->
    <div class="video-container ripple">
        <video id="bgVideo" autoplay muted>
            <source src="/website/scentopia/video/elixir/Nebula_Nectar_opening2.mp4" type="video/mp4">
        </video>
    </div>
            ...
            <div class="product-descriptionsentopia ">
                ...
                <div class="row justify-content-between icon-grid">
                    ...
                    <div class="col-md-4   mb-2 mb-md-0 col-12">
                        <img src="/website/scentopia/product/elixir/Nebula Nector.svg">
                    </div>
                    <div class="col-md-4  mb-5 mb-md-0 col-12">
                        <p>
                            Evoking the ethereal beauty of the cosmos the scent combines Egyptian Jasmine Absolute,
                            leather, and amber in a refined blend.
                        </p>
                        <div class="know-more">
        ...
        <div class="container">
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/mood/Energetic-674e8f399e8c2.png"
                            alt="Myrrh Oil" class="icon-bubble">
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    ...
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Traveling-674ee9c1f0243.png"
                            alt="Outdoor Adventure" class="icon-bubble">
                        <div><strong>Ignite Your Spirit</strong></div>
                        <small>Perfect For Outdoor Adventure</small>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="text-center px-3">
                        <p class="text-light">
                            <strong>Aromatic</strong> 15.83% |
                            <strong>Woody</strong> 14.63% |
                            <strong>Powdery</strong> 13.77% |
                            <strong>Green</strong> 12.39% |
                            <strong>Animalic</strong> 11.19% |
                            <strong>Fresh Spicy</strong> 10.33% |
                            <strong>White floral</strong> 8.60% |
                            <strong>Musky</strong> 7.23% |
                            <strong>Sweet</strong> 6.02%
                        </p>
            ...
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            labels: [
                                'Aromatic', 'Woody', 'Powdery', 'Green',
                                'Animalic', 'Fresh Spicy', 'White floral', 'Musky', 'Sweet'
                            ],
                            datasets: [{
                                label: 'Fragrance Notes',
                                data: [
                                    15.83, 14.63, 13.77, 12.39,
                                    11.19, 10.33, 8.60, 7.23, 6.02
                                ],
                                backgroundColor: [
                                    '#2d9b8f', '#7b5b2a', '#eae3db',
                                    '#3cad3a', '#b79662', '#9acd7c',
                                    '#eae9f2', '#d5c8dc', '#f4b9b6'
                                ],
