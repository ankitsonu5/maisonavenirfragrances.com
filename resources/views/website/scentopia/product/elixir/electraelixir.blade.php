<x-app-layout :title="'Electra Elixir | Classic Floral Chypre - Maison de l Avenir'" :description="'Discover Electra Elixir&apos;s timeless Floral Chypre elegance with bergamot, jasmine & sandalwood. Luxury 48-hour unisex fragrance crafted in UAE.'">

    <!-- Video Section -->
    <div class="video-container ripple">
        <video id="bgVideo" autoplay muted>
            <source src="/website/scentopia/video/elixir/Electra_Elixir_2.mp4" type="video/mp4">
        </video>
    </div>
            ...
            <div class="product-descriptionsentopia ">
                ...
                <div class="row justify-content-between icon-grid">
                    ...
                    <div class="col-md-4   mb-2 mb-md-0 col-12">
                        <img src="/website/scentopia/product/elixir/Electra Elixir.svg">

                    </div>
                    <div class="col-md-4  mb-5 mb-md-0 col-12">
                        <p>
                            Inspired by the vastness of space, this fragrance opens with bergamot, lemon, and orange,
                            evoking starlight and a cosmic breeze.
                        </p>
                        <div class="know-more">
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="text-center px-3">
                        <p class="text-light">
                            <strong>Citrus</strong> 14.68% |
                            <strong>Aromatic</strong> 13.51% |
                            <strong>Woody</strong> 12.48% |
                            <strong>Powdery</strong> 11.75% |
                            <strong>Green</strong> 10.57% |
                            <strong>Animalic</strong> 9.54% |
                            <strong>Fresh Spicy</strong> 8.81% |
                            <strong>White floral</strong> 7.34% |
                            <strong>Musky</strong> 6.17% |
                            <strong>Sweet</strong> 5.14%
                        </p>
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            labels: [
                                ...
                                'Animalic', 'Fresh Spicy', 'White floral', 'Musky', 'Sweet'
                            ],
                            datasets: [{
                                label: 'Fragrance Notes',
                                data: [
                                    14.68, 13.51, 12.48, 11.75, 10.57,
                                    9.54, 8.81, 7.34, 6.17, 5.14
                                ],
                                backgroundColor: [
                                    '#f7f54a', '#2d9b8f', '#7b5b2a', '#eae3db',
                                    '#3cad3a', '#b79662', '#9acd7c', '#eae9f2',
                                    '#d5c8dc', '#f4b9b6'
                                ],
