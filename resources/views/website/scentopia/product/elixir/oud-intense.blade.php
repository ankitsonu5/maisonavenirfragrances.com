<x-app-layout :title="'Oud Intense | Floral Oriental Perfume - Maison de l Avenir'" :description="'Discover Oud Intense&apos;s luxurious Floral Oriental blend with rose, jasmine & precious oud. 48-hour lasting unisex fragrance crafted with natural oils.'">


    <!-- Video Section -->
    <div class="video-container ripple">
        <video id="bgVideo" autoplay muted>
            <source src="/website/scentopia/video/elixir/Oud_Intense.mp4" type="video/mp4">
        </video>
    </div>
            ...
            <div class="product-descriptionsentopia ">
                ...
                <div class="row justify-content-between icon-grid">
                    ...
                    <div class="col-md-4   mb-2 mb-md-0 col-12">
                        <img src="/website/scentopia/product/elixir/Oud Intense.svg">
                    </div>
                    <div class="col-md-4  mb-5 mb-md-0 col-12">
                        <p>
                            Discover the essence of Middle Eastern fragrance rituals with exquisite Boya Oud essential
                            oil blended with Rose absolute.
                        </p>
                        <div class="know-more">
                            <a href="https://www.maisonavenirfragrances.com/our-fragrance/detail/oud-intense"
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/mood/Sensual-674e8f1fabb2a.png"
                            alt="Ylang Ylang Oil" class="icon-bubble">
                        <div><strong>Contains Ylang Ylang Oil</strong></div>
                        <small>
                    ...
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/mood/Nostagic-674e8f7a37dbd.png"
                            alt="Geranium Oil" class="icon-bubble">
                        <div><strong>Contains Geranium Oil</strong></div>
                        <small>
                            <span style="color:#cab651">Mood Impact:</span><br>
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Social-Gatherings-674ee99d03b54.png"
                            alt="Weekend Outings" class="icon-bubble">
                        <div><strong>Experience The Romance</strong></div>
                        <small>Perfect For Weekend Outings</small>
                    </div>

                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Social-Gatherings-674ee99d03b54.png"
                            alt="Social Gatherings" class="icon-bubble">
                        <div><strong>Celebrate Connections</strong></div>
                        <small>Perfect For Social Gatherings</small>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="text-center px-3">
                        <p class="text-light">
                            <strong>Warm Spicy</strong> 14.88% |
                            <strong>Woody</strong> 13.39% |
                            <strong>Powdery</strong> 12.65% |
                            <strong>Amber</strong> 11.16% |
                            <strong>Vanilla</strong> 10.42% |
                            <strong>White floral</strong> 9.67% |
                            <strong>Fresh Spicy</strong> 8.93% |
                            <strong>Rose</strong> 7.44% |
                            <strong>Musky</strong> 6.24% |
                            <strong>Aromatic</strong> 5.21%
                        </p>
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            labels: [
                                ...
                                'White floral', 'Fresh Spicy', 'Rose', 'Musky', 'Aromatic'
                            ],
                            datasets: [{
                                label: 'Fragrance Notes',
                                data: [
                                    14.88, 13.39, 12.65, 11.16, 10.42,
                                    9.67, 8.93, 7.44, 6.24, 5.21
                                ],
                                backgroundColor: [
                                    '#d63c1a', '#6d4c41', '#eae3db', '#c56c36',
                                    '#fcecc9', '#f5f5f5', '#a8e6a3', '#f48fb1',
                                    '#d5c8dc', '#2d9b8f'
                                ],
