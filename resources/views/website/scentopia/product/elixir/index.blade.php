<x-app-layout :title="'Elixir Collection | Interactive Scent Experience'" :description="'Discover the Elixir collection with interactive content in Scentopia. Dive deeper into each fragrance.
'">
