<x-app-layout :title="'Noir Intense | Aromatic Fougère Fragrance - Maison de l Avenir'" :description="'Experience Noir Intense&apos;s urbane Aromatic Fougère scent with bergamot, lemon & patchouli. Dynamic unisex fragrance inspired by urban landscapes.'">


    <!-- Video Section -->
    <div class="video-container ripple">
        <video id="bgVideo" autoplay muted>
            <source src="/website/scentopia/video/aura/Noir_Intense.mp4" type="video/mp4">
        </video>
    </div>
            ...
            <div class="product-descriptionsentopia ">
                ...
                <div class="row justify-content-between icon-grid">
                    ...
                    <div class="col-md-4   mb-2 mb-md-0 col-12">
                        <img src="/website/scentopia/product/aura/Noir Intense.svg">

                    </div>
                    <div class="col-md-4  mb-5 mb-md-0 col-12">
                        <p>
                            Embodying the elegance and dynamism of the urban landscape, this fragrance bursts with
                            bergamot, geranium, nutmeg and violet.
                        </p>
                        <div class="know-more">
                            <a href="https://www.maisonavenirfragrances.com/our-fragrance/detail/noir-intense"
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/mood/Happy-674e901726d98.png"
                            alt="Vetiver Oil" class="icon-bubble">
                        <div><strong>Contains Vetiver Oil</strong></div>
                        <small>
                    ...
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/mood/Relaxed-674e904067978.png"
                            alt="Lavender Oil" class="icon-bubble">
                        <div><strong>Contains Lavender Oil</strong></div>
                        <small>
                            <span style="color:#cab651">Mood Impact:</span><br>
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Work-674ee93e4d3cc.png"
                            alt="Casual And Office Wear" class="icon-bubble">
                        <div><strong>For Everyday Confidence</strong></div>
                        <small>Perfect For Casual And Office Wear</small>
                    </div>

                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Romantic-Evening-674ee8b1e0079.png"
                            alt="Date Nights" class="icon-bubble">
                        <div><strong>Stand Out With Ease</strong></div>
                        <small>Perfect For Date Nights</small>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="text-center px-3">
                        <p class="text-light">
                            <strong>Fresh Spicy</strong> 12.90% |
                            <strong>Aromatic</strong> 12.26% |
                            <strong>Woody</strong> 11.61% |
                            <strong>Citrus</strong> 10.97% |
                            <strong>Green</strong> 10.32% |
                            <strong>Soft Spicy</strong> 9.68% |
                            <strong>Herbal</strong> 9.03% |
                            <strong>Powdery</strong> 8.39% |
                            <strong>White Floral</strong> 7.74% |
                            <strong>Warm Spicy</strong> 7.10%
                        </p>
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            labels: [
                                ...
                                'Soft Spicy', 'Herbal', 'Powdery', 'White Floral', 'Warm Spicy'
                            ],
                            datasets: [{
                                ...
                                backgroundColor: [
                                    '#a8e6a3', '#2d9b8f', '#7b5b2a', '#f7f54a',
                                    '#3cad3a', '#e89f89', '#c1ece4', '#eae3db',
                                    '#f5f5f5', '#d63c1a'
                                ],
