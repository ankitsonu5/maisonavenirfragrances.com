<x-app-layout :title="'Aura Collection | Interactive Scent Experience'" :description="'Explore the Aura collection in Scentopia. Enjoy immersive animations and videos for each fragrance.'">
    ...
    <div class="container  my-4">
        <div class="row justify-content-between">
            ...
            <div class="col-md-4 col-12 order-2 order-md-1">
                <h1 class="page-heading">Experience our <br> Aura Collection</h1>
            </div>
