<x-app-layout :title="'Ethereal Embrace | Velvety Unisex Perfume'" :description="'Entice your senses with Ethereal Embrace, a velvety fragrance blending fruity and floral notes. Shop Maison de l\'Avenir.'">
    <!-- Video Section -->
    <div class="video-container ripple">
        <video id="bgVideo" autoplay muted>
            <source src="/website/scentopia/video/aura/Ethereal_Embrace.mp4" type="video/mp4">
        </video>
    </div>
            ...
            <div class="product-descriptionsentopia ">
                ...
                <div class="row justify-content-between icon-grid">
                    ...
                    <div class="col-md-4   mb-2 mb-md-0 col-12">
                        <img src="/website/scentopia/product/aura/Ethereal Embrace.svg">

                    </div>
                    <div class="col-md-4  mb-5 mb-md-0 col-12">

                        <p>
                            Savor life’s sweetest moments. An indulgent base of marshmallow, whipped cream and vanilla
                            wraps you in a velvety embrace.
                        </p>
                        <div class="know-more">
                            <a href="https://www.maisonavenirfragrances.com/our-fragrance/detail/ethereal-embrace"
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    ...
                    <div class="content-block">
                        ...
                        <div><strong>Cherish the Good Times</strong></div>
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="text-center px-3">
                        <p class="text-light">
                            ...
                            <strong>White floral</strong> 11.61% |
                            <strong>Vanilla</strong> 10.97% |
                            <strong>Powdery</strong> 10.32% |
                            <strong>Fruity</strong> 9.68% |
                            <strong>Woody</strong> 9.03% |
                            <strong>Floral</strong> 8.39% |
                            <strong>Green</strong> 7.74% |
                            <strong>Musky</strong> 7.10%
                        </p>
            ...
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            labels: [
                                'Sweet', 'Citrus', 'White floral', 'Vanilla', 'Powdery',
                                'Fruity', 'Woody', 'Floral', 'Green', 'Musky'
                            ],
                            datasets: [{
                                ...
                                backgroundColor: [
                                    '#e63946', '#f7f54a', '#f5f5f5', '#fcecc9',
                                    '#eae3db', '#f08080', '#7b5b2a', '#f8bbd0',
                                    '#3cad3a', '#eae9f2'
                                ],
