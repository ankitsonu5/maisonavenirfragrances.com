<x-app-layout :title="'Jardin De Jade | Floral Green Fragrance - Maison de l Avenir'" :description="'Experience Jardin De Jade&apos;s fresh Floral Green blend with green apple, jasmine & white musk. Nature-inspired unisex fragrance with earthy elegance.'">


    <!-- Video Section -->
    <div class="video-container ripple">
        <video id="bgVideo" autoplay muted>
            <source src="/website/scentopia/video/aura/Jardin_De_Jade.mp4" type="video/mp4">
        </video>
    </div>
            ...
            <div class="product-descriptionsentopia ">
                ...
                <div class="row justify-content-between icon-grid">
                    ...
                    <div class="col-md-4   mb-2 mb-md-0 col-12">
                        <img src="/website/scentopia/product/aura/Jardin de Jade.svg">

                    </div>
                    <div class="col-md-4  mb-5 mb-md-0 col-12">

                        <p>
                            Embrace joy as its delightful scent surrounds you with a bouquet of lively florals-roses,
                            orange blossoms, heliotrope, and more.
                        </p>
                        <div class="know-more">
                            <a href="https://www.maisonavenirfragrances.com/our-fragrance/detail/jardin-de-jade"
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    ...
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/mood/Energetic-674e8f399e8c2.png"
                            alt="Lime Oil" class="icon-bubble">
                        <div><strong>Contains Lime Oil</strong></div>
                        <small>
                            <span style="color:#cab651">Mood Impact:</span><br>
                ...
                <div class="col-md-5 d-flex justify-content-between">
                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Social-Gatherings-674ee99d03b54.png"
                            alt="Family Gatherings" class="icon-bubble">
                        <div><strong>Spread Joy</strong></div>
                        <small>Ideal For Family Gatherings</small>
                    </div>

                    <div class="content-block">
                        <img src="https://www.maisonavenirfragrances.com/storage/occasion/Formal-Event-674ee852435ec.png"
                            alt="Everyday Wear" class="icon-bubble">
                        <div><strong>Brighten Your Day</strong></div>
                        <small>Great For Everyday Wear</small>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="text-center px-3">
                        <p class="text-light">
                            <strong>Sweet</strong> 12.90% |
                            <strong>Citrus</strong> 12.26% |
                            <strong>Fruity</strong> 11.61% |
                            <strong>Powdery</strong> 10.97% |
                            <strong>White floral</strong> 10.32% |
                            <strong>Woody</strong> 9.68% |
                            <strong>Floral</strong> 9.03% |
                            <strong>Fresh Spicy</strong> 8.39% |
                            <strong>Vanilla</strong> 7.74% |
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            labels: [
                                ...
                                'Woody', 'Floral', 'Fresh Spicy', 'Vanilla', 'Fresh'
                            ],
                            datasets: [{
                                ...
                                backgroundColor: [
                                    '#e63946', '#f7f54a', '#f08080', '#eae3db',
                                    '#f5f5f5', '#7b5b2a', '#f8bbd0', '#a8e6a3',
                                    '#fcecc9', '#c1ece4'
                                ],
