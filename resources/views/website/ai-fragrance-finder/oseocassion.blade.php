        ...
        {{-- <nav class="breadcrumb-container" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item " aria-current="page"><a
                        href="{{ route('AIFragranceFinder.choosemood') }}">Mood</a></li>
                <li class="breadcrumb-item active" aria-current="page">Occasion</li>
            </ol>
        </nav> --}}
        ...
        <div class="ingredients">
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="ingredient-headding">
                        <h1 class="ingredientheading">Choose the Occasion</h1>
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <form action="{{ route('chooseocassion.store') }}" method="POST" id="ingredientsForm">
                        @csrf
                        <div class="row">
                            @foreach ($oseocassions as $occasion)
                            <div class="col-md-3 col-4">
                                <div class="box ingredient-box" data-id="{{ $occasion->id }}">
                                    <img src="{{ asset('storage/occasion/' . $occasion->image_new) }}"
                                        alt="{{ $occasion->occasion }}" class="item-image">
                                    <p class="ingredient-name">{{ $occasion->occasion }}</p>
                                </div>
                            </div>
                            @endforeach
                        </div>
                        ...
                        <input type="hidden" name="oseocassion_id" id="selecteditem">
                        <div class="d-flex justify-content-center mt-3 mx-5">
                            <a href="{{ route('AIFragranceFinder.form') }}" class="back-btn">
                            ...
                            <button type="submit" disabled id="submitbutton" class="next-btn mx-2">Submit</button>
                        </div>
                ...
                <div class="col-md-3 selectedbox ">
                    <div>
                        ...
                        @if (session('personalize_further'))
                        ...
                        <div class="previous-container">
                            @foreach ($fragrancefamilys as $family)
                            <div class="selected-item">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="itemname">Mood</p>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('session.resate', ['session' => 'mood_id']) }}" class="back-btn">
                                    Reset </a>
                            </div>
                        </div>
                        <div class="previous-container">
                            ...
                            <div class="selected-item">
                                <img src="{{ asset('storage/mood/' . $mood->image_new) }}" alt="{{ $mood->mood }}">
                                <p>{{ $mood->mood }}</p>
                            </div>
                            @endforeach
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <p class="itemname">Occasion</p>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('session.resate', ['session' => 'oseocassion_id']) }}"
                                    class="back-btn">
                                    Reset </a>
                            </div>
                        </div>
            ...
            <div class="offcanvas-body">
                <div class="ingredient-headding">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('session.resate', ['session' => 'oseocassion_id']) }}" class="back-btn">
                                Reset </a>
                        </div>
                    </div>
                    <div class="selected-image-container"></div>
