    ...
    <div class="container my-5">
        ...
        <nav class="breadcrumb-container" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Mood</li>
            </ol>
        </nav> --}}
        ...
        <div class="ingredients">
            <div class="row">
                <div class="col-md-9">
                    <div class="ingredient-headding">
                        <h1 class="ingredientheading">Choose the Mood</h1>
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <form action="{{ route('choosemood.store') }}" method="POST" id="ingredientsForm">
                        @csrf
                        <div class="row">
                            @foreach ($moods as $mood)
                            <div class="col-md-3 col-4">
                                <div class="box ingredient-box" data-id="{{ $mood->id }}">
                                    <img src="{{ asset('storage/mood/' . $mood->image_new) }}" alt="{{ $mood->mood }}"
                                        class="item-image">
                                    <p class="ingredient-name">{{ $mood->mood }}</p>
                                </div>
                            </div>
                            @endforeach
                        </div>
                        ...
                        <input type="hidden" name="mood_id" id="selecteditem">
                        <div class="d-flex justify-content-center mt-3 mx-5">
                            ...
                            <a href="{{ route('chooseocassion.show') }}" class="back-btn ">
                                <div>Skip</div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
