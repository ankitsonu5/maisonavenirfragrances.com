...
(function (T, O) {
    ...
    O(n, "Core/Utilities.js", [n["Core/Globals.js"]], function (f) {
        function a(b, c, e, d) {
            ...
            e
                ? ea(e, "displayError", { code: b, message: g, params: d }, z)
                : z();
            a.messages.push(g);
        }
        function S() {
                ...
                if (w && g) {
                    for (b = 0; b < w.length; b++)
                        if (w[b] === g[0]) {
                            ...
                            w[w.length - 1] === g[g.length - w.length + b]
                        ) {
                            P = w.length - b;
                            break;
                        }
        ...
        var q = (f.pInt = function (b, c) {
            ...
            E = (f.isArray = function (b) {
                ...
                return (
                    "[object Array]" === b || "[object Array Iterator]" === b
                );
            });
        f.isObject = y;
        ...
        var d = (f.css = function (b, c) {
            ...
            X = (f.numberFormat = function (b, c, e, d) {
                ...
                if (-1 === c) c = Math.min(w, 20);
                    ...
                    var h = c + +g[1];
                    0 <= h
                        ? ((g[0] = (+g[0]).toExponential(h).split("e")[0]),
                          (c = h))
                        : ((g[0] = g[0].split(".")[0] || 0),
                          (b =
                              20 > c
                                  ? (g[0] * Math.pow(10, g[1])).toFixed(c)
                                  : 0),
                          (g[1] = 0));
                }
                var k = (
                    Math.abs(g[1] ? g[0] : b) +
                    Math.pow(10, -Math.max(c, w) - 1)
                ).toFixed(c);
                w = String(q(k));
                ...
                if ("width" === c)
                    return (
                        ...
                        Math.max(
                            0,
                            c -
                                f.getStyle(b, "padding-left") -
                                f.getStyle(b, "padding-right"),
                        )
                    );
                if ("height" === c)
                    return Math.max(
        ...
        var Q = (f.offset = function (b) {
                ...
                return {
                    top:
                        b.top +
                        (v.pageYOffset || c.scrollTop) -
                        (c.clientTop || 0),
                    left:
                        b.left +
                        (v.pageXOffset || c.scrollLeft) -
                        (c.clientLeft || 0),
                };
            }),
            ...
            U = (f.objectEach = function (b, c, e) {
                for (var d in b)
                    Object.hasOwnProperty.call(b, d) &&
                        c.call(e || b[d], b[d], d, b);
            });
        U(
            {
                map: "map",
        ...
        var ja = (f.addEvent = function (b, c, e, d) {
            ...
            ha = (f.removeEvent = function (b, c, e) {
                function d(c, e) {
                    var d =
                        b.removeEventListener || f.removeEventListenerPolyfill;
                    d && d.call(b, c, e, !1);
                }
                function z(e) {
                    var z;
                ...
                if (H.createEvent && (b.dispatchEvent || b.fireEvent)) {
                    ...
                    (e.target ||
                        ...
                        (function (c, d) {
                            ...
                            b.protoEvents && b.protoEvents[c],
                            b.hcEvents && b.hcEvents[c],
                        ));
            ...
            oa = (f.setOptions = function (b) {
                ...
                (b.time || b.global) &&
                    f.time.update(
                        S(
                            f.defaultOptions.global,
                            f.defaultOptions.time,
                            b.global,
                            b.time,
                        ),
                    );
        ...
        function (f, a, n) {
            ...
            n = (function () {
                ...
                F.prototype.animate = function (e, c, b) {
                    ...
                    c = w.defer;
                    A(D.hidden, D.msHidden, D.webkitHidden, !1) &&
                        (w.duration = 0);
                    0 !== w.duration
                        ? (b && (w.complete = b),
                          M(function () {
                        ...
                        : (this.attr(e, void 0, b),
                          r(
                              ...
                              function (b, c) {
                                  w.step &&
                                      w.step.call(this, b, { prop: c, pos: 1 });
                              },
                              this,
                          ));
                    return this;
                ...
                F.prototype.attr = function (e, c, b, d) {
                    ...
                    "string" === typeof e
                        ? (h = (this[e + "Getter"] || this._defaultGetter).call(
                              this,
                              e,
                              z,
                          ))
                ...
                F.prototype.css = function (e) {
                    ...
                    if (g) {
                        ...
                        this.added &&
                            ...
                            e &&
                                e.textOutline &&
                                this.applyTextOutline(e.textOutline));
                    }
                    return this;
                };
                    ...
                    if (b) {
                        if (
                            ...
                            this.textPathWrapper &&
                                b.getElementsByTagName("textPath").length)
                        ) {
                            for (
                                e = this.textPathWrapper.element.childNodes;
                                e.length;
                            )
                                b.appendChild(e[0]);
                    ...
                    if (!b) {
                        ...
                        d.isSVG &&
                            ...
                            c &&
                                ((g = c * y),
                                (b.width =
                                    Math.abs(d * Math.sin(g)) +
                                    Math.abs(e * Math.cos(g))),
                                (b.height =
                                    Math.abs(d * Math.cos(g)) +
                                    Math.abs(e * Math.sin(g)))));
                        if (B && 0 < b.height) {
                ...
                F.prototype.hasClass = function (e) {
                    return (
                        -1 !== ("" + this.attr("class")).split(" ").indexOf(e)
                    );
                };
                ...
                F.prototype.setTextPath = function (e, c) {
                    ...
                    if (e && c && c.enabled) {
                        ...
                        if (h)
                            for (
                                e = b.getElementsByTagName("tspan");
                                e.length;
                            )
                        ...
                        I(l.dy) &&
                            (m.parentNode.setAttribute("dy", l.dy),
                            delete l.dy);
                        I(l.dx) &&
                            (m.parentNode.setAttribute("dx", l.dx),
                            delete l.dx);
                        r(l, function (b, c) {
                ...
                F.prototype.zIndexSetter = function (e, c) {
                    ...
                    if (l) {
                        ...
                        for (r = c.length - 1; 0 <= r && !h; r--) {
                            ...
                            if (d !== k)
                                if (0 > e && m && !b && !r)
                                    (g.insertBefore(k, c[r]), (h = !0));
                                else if (N(l) <= e || (m && (!I(e) || 0 <= e)))
                                    (g.insertBefore(k, c[r + 1] || null),
                                        (h = !0));
                        }
                        h ||
                            (g.insertBefore(k, c[b ? 3 : 0] || null), (h = !0));
                    }
                    return h;
                };
                return F;
                    ...
                    var a = this.text.element.style,
                        ...
                        p =
                            ...
                            !y(this.text.textStr)
                                ...
                                : this.text.getBBox();
                    this.width =
                        (this.widthSetting || p.width || 0) + 2 * H + E;
                ...
                e = (function () {
                            ...
                            l(b).forEach(function (b) {
                                ...
                                b.textContent &&
                                    w.element.appendChild(
                                        x.createTextNode(b.textContent),
                                    );
                                c(b.children || [], w);
                                g = w;
                            });
                    ...
                    c.prototype.crispLine = function (b, c, e) {
                        ...
                        var d = b[0],
                            g = b[1];
                        d[1] === g[1] &&
                            (d[1] = g[1] = Math[e](d[1]) - (c % 2) / 2);
                        d[2] === g[2] &&
                            (d[2] = g[2] = Math[e](d[2]) + (c % 2) / 2);
                        return b;
                    };
                    ...
                    c.prototype.fontMetrics = function (b, c) {
                        b =
                            ...
                            !F.getComputedStyle
                                ...
                                : c &&
                                  n.prototype.getStyle.call(c, "font-size");
                        b = /px/.test(b) ? h(b) : 12;
                        ...
                        for (
                            ...
                            (t(e[0]) &&
                                ...
                                b.splice(
                                    g,
                                    0,
                                    e[0].replace("M", "L").replace("m", "l"),
                                ),
                                "string" === typeof b[g] &&
                                    (e.length && c.push(e.slice(0)),
                                    (e.length = 0)),
                                e.push(b[g]));
                        c.push(e.slice(0));
                        return c;
    ...
    O(
        ...
        function (f, a) {
            ...
            a = (function () {
                        ...
                        a.shortenLabel = function () {
                            for (N = 0; N < B.length; N++)
                                if (
                                    ...
                                    A.getBBox().width <
                                        t.getSlotWidth(a) - 2 * q(g.padding, 5))
                                )
                                    return;
                            A.attr({ text: "" });
                        };
                    ...
                    a = {
                        x: a
                            ...
                            : m.left +
                              m.offset +
                              (m.opposite
                                  ? ((u && h.oldChartWidth) || h.chartWidth) -
                                    m.right -
                                    m.left
                                  : 0),
                        y: a
                            ? l -
                              m.bottom +
                              m.offset -
                              (m.opposite ? m.height : 0)
                            : y(
                                  l -
                                      m.translate(t + f, null, null, u) -
                                      m.transB,
                              ),
                    };
                    a.y = n(a.y, -1e5, 1e5);
                ...
                a.prototype.getLabelPosition = function (
                    a,
                    t,
                    f,
                    u,
                        ...
                        x &&
                            ((this.mark = d =
                                h
                                    ...
                                    .add(p.axisGroup)),
                            p.chart.styledMode ||
                                d.attr({ stroke: m, "stroke-width": A })),
                        d[x ? "attr" : "animate"]({
                            d: this.getMarkPath(
                                r,
                                a,
                ...
                a.prototype.renderLabel = function (a, f, I, u) {
                    ...
                    k &&
                        H(r) &&
                        ((k.xy = a =
                            this.getLabelPosition(r, a, k, h, g, m, u, d)),
                        (this.isFirst &&
                            !this.isLast &&
                            !q(l.showFirstLabel, 1)) ||
            ...
            a = (function () {
                ...
                a.prototype.timezoneOffsetFunction = function () {
                    ...
                    if (!this.useUTC)
                        return function (a) {
                            return (
                                6e4 * new Date(a.toString()).getTimezoneOffset()
                            );
                        };
                    if (f.timezone) {
                        if (q)
                ...
                a.prototype.getTimeTicks = function (a, f, I, u) {
                    ...
                    if (n(f)) {
                        m.set(
                            ...
                            g >= q.second
                                ? 0
                                : d * Math.floor(m.get("Milliseconds", k) / d),
                        );
                        g >= q.second &&
                            m.set(
                                "Seconds",
                                ...
                                g >= q.minute
                                    ? 0
                                    : d * Math.floor(m.get("Seconds", k) / d),
                            );
                        g >= q.minute &&
                            m.set(
                                "Minutes",
                                ...
                                g >= q.hour
                                    ? 0
                                    : d * Math.floor(m.get("Minutes", k) / d),
                            );
                        g >= q.hour &&
                            m.set(
                                "Hours",
                        ...
                        m.variableTimezone &&
                            (x =
                                I - f > 4 * q.month ||
                                m.getTimezoneOffset(f) !==
                                    m.getTimezoneOffset(I));
                        f = k.getTime();
                        for (k = 1; f < I; )
                            (h.push(f),
                                (f =
        ...
        function (f, a, n, y, D) {
            ...
            y = (function () {
                ...
                e.prototype.init = function (c, b) {
                    ...
                    d.side =
                        b.side ||
                        (d.horiz ? (d.opposite ? 0 : 2) : d.opposite ? 1 : 3);
                    d.setOptions(b);
                    var g = this.options,
                        k = g.type;
                    d.labelFormatter =
                        g.labels.formatter || d.defaultLabelFormatter;
                    d.userOptions = b;
                    d.minPixelPadding = 0;
                    ...
                    -1 === c.axes.indexOf(d) &&
                        (e
                            ? c.axes.splice(c.xAxis.length, 0, d)
                            : c.axes.push(d),
                        c[d.coll].push(d));
                    d.series = d.series || [];
                    c.inverted &&
                ...
                e.prototype.toPixels = function (c, b) {
                    return (
                        this.translate(c, !1, !this.horiz, null, !0) +
                        (b ? 0 : this.pos)
                    );
                };
                ...
                e.prototype.adjustForMinRange = function () {
                    ...
                    if (e - b < this.minRange) {
                        ...
                        e = [b + x, r(c.max, b + x)];
                        m &&
                            (e[2] = d ? d.log2lin(this.dataMax) : this.dataMax);
                        e = H(e);
                        e - b < x &&
                            ((f[0] = e - x),
                            (f[1] = r(c.min, e - x)),
                ...
                e.prototype.setTickInterval = function (c) {
                    ...
                    b.tickInterval =
                        ...
                        "undefined" === typeof b.max
                            ...
                            : a &&
                                !f &&
                                p === b.linkedParent.options.tickPixelInterval
                        ...
                        if (k < d) {
                            for (a = this.min; e.length < d; )
                                e.length % 2 || a === h
                                    ...
                                    : e.unshift(L(e[0] - b));
                            this.transA *= (k - 1) / (d - 1);
                            this.min = c.startOnTick
                                ? e[0]
                                : Math.min(this.min, e[0]);
                ...
                e.prototype.setAxisSize = function () {
                    var c = this.chart,
                        ...
                        g = (this.width = Math.round(
                            A(
                                r(b.width, c.plotWidth - e[3] + e[1]),
                                c.plotWidth,
                            ),
                        )),
                        k = (this.height = Math.round(
                            A(
                                r(b.height, c.plotHeight - e[0] + e[2]),
                                c.plotHeight,
                            ),
                        )),
                        h = (this.top = Math.round(
                            A(
                                r(b.top, c.plotTop + e[0]),
                                c.plotHeight,
                                c.plotTop,
                            ),
                        ));
                ...
                e.prototype.tickSize = function (c) {
                    var b = this.options,
                        ...
                        d = r(
                            ...
                            "tick" === c && this.isXAxis && !this.categories
                                ? 1
                                : 0,
                        );
                    if (d && e) {
                ...
                e.prototype.getSlotWidth = function (c) {
                    ...
                    if (d && g && 2 > (g.step || 0))
                        return g.rotation
                            ? 0
                            : ((this.staggerLines || 1) * this.len) / k;
                    if (!d) {
                        c =
                            null ===
                                (b =
                ...
                e.prototype.renderUnsquish = function () {
                    ...
                    if (this.autoRotation)
                        ...
                        if (!f) {
                            ...
                            for (m = e.length; !a && m--; ) {
                                ...
                                if ((t = d[t].label))
                                    (t.styles &&
                                    "ellipsis" === t.styles.textOverflow
                                        ? t.css({ textOverflow: "clip" })
                                        : t.textPxLength > l &&
                                          t.css({ width: l + "px" }),
                                        t.getBBox().height >
                                            this.len / e.length - (x.h - x.f) &&
                                            (t.specificTextOverflow =
                                                "ellipsis"));
                            }
                        }
                    }
                    r.rotation &&
                        ((B =
                            p > 0.5 * c.chartHeight ? 0.33 * c.chartHeight : p),
                        f || (A = "ellipsis"));
                    if (
                        (this.labelAlign =
                ...
                e.prototype.getOffset = function () {
                    ...
                    if (
                        ...
                        c.titleOffset = f =
                            c.axisTitle.getBBox()[h ? "height" : "width"];
                        var R = B.offset;
                        p = q(R) ? 0 : r(B.margin, h ? 5 : 10);
                    }
                    c.renderLine();
                    c.offset =
                        u * r(d.offset, F[a] ? F[a] + (d.margin || 0) : 0);
                    ...
                    M &&
                        (p =
                            p -
                            e +
                            u * (h ? r(A.y, c.tickRotCorr.y + 8 * u) : A.x));
                ...
                e.prototype.getTitlePosition = function () {
                    var c = this.horiz,
                        ...
                        m = g.y || 0,
                        r = this.axisTitle,
                        x = this.chart.renderer.fontMetrics(
                ...
                e.prototype.destroy = function (c) {
                    ...
                    c || N(b);
                    [b.ticks, b.minorTicks, b.alternateBands].forEach(
                        function (b) {
                            K(b);
                        },
                    );
                    ...
                    if (this.crosshair && !1 !== (q(b) || !d)) {
                        ...
                        if (q(g)) {
                            var a = {
                                value:
                                    b &&
                                    (this.isXAxis ? b.x : r(b.stackY, b.y)),
                                translatedValue: g,
                            };
                            h.polar &&
                                p(a, {
                ...
                e.prototype.hasVerticalPanning = function () {
                    ...
                    return /y/.test(
                        (null ===
                            (b =
                                null === (c = this.chart.options.chart) ||
                                void 0 === c
                                    ? void 0
                                    : c.panning) || void 0 === b
                            ? void 0
            ...
            var n = a.addEvent,
                ...
                C = (function () {
                    ...
                    a.prototype.getLogTickPositions = function (a, f, n, q) {
                        ...
                        if (0.5 <= a)
                            ((a = Math.round(a)),
                                (t = v.getLinearTickPositions(a, f, n)));
                        else if (0.08 <= a) {
                            p = Math.floor(f);
                            var I, u;
                            for (
                            ...
                            ((f = this.lin2log(f)),
                                (n = this.lin2log(n)),
                                (a = q
                                    ? v.getMinorTickInterval()
                                    : p.tickInterval),
                                (a = G(
                                    "auto" === a ? null : a,
                                    this.minorAutoInterval,
                                    ((p.tickPixelInterval / (q ? 5 : 1)) *
                                        (n - f)) /
                                        ((q ? E / v.tickPositions.length : E) ||
                                            1),
                                )),
                                (a = D(a, void 0, y(a))),
                                (t = v
                                    .getLinearTickPositions(a, f, n)
                                    .map(this.log2lin)),
                ...
                K = (function () {
                    ...
                    f.prototype.renderLabel = function (a, f, q, u) {
                        ...
                        m ||
                            ...
                            (this.label = m =
                                h.text(u, 0, 0, a.useHTML).attr(m).add()),
            ...
            var u = (function () {
                ...
                m.prototype.bodyFormatter = function (h) {
                    return h.map(function (h) {
                        ...
                        return (
                            k[
                                (h.point.formatPrefix || "point") + "Formatter"
                    ...
                    this.followPointer && a
                        ...
                        : h[0].tooltipPos
                          ...
                          : (h.forEach(function (g) {
                                ...
                                t +=
                                    (g.plotLow
                                        ? (g.plotLow + g.plotHigh) / 2
                                        : g.plotY) + (!d && B ? B.top - l : 0);
                            }),
                            (m /= h.length),
                            (t /= h.length),
                            (h = [
                ...
                m.prototype.getDateFormat = function (h, a, k, g) {
                    ...
                    for (p in I) {
                        ...
                        if (
                            f[p] &&
                            l.substr(f[p]) !== "01-01 00:00:00.000".substr(f[p])
                        )
                            break;
                        "week" !== p && (m = p);
                    }
                ...
                m.prototype.getLabel = function () {
                    var h,
                        ...
                        r =
                            "tooltip" +
                            (G(m.className) ? " " + m.className : ""),
                        p =
                            (null === (h = m.style) || void 0 === h
                                ? void 0
                                : h.pointerEvents) ||
                            (!this.followPointer && m.stickOnContact
                                ? "auto"
                                : "none"),
                        t;
                    h = function () {
                        ...
                        this.outside &&
                            ...
                            (this.renderer = g =
                                new f.Renderer(
                                    ...
                                    0,
                                    0,
                                    null === (a = this.chart.options.chart) ||
                                        void 0 === a
                                        ? void 0
                                        : a.style,
                                    void 0,
                ...
                m.prototype.getPosition = function (a, l, k) {
                    var g = this.chart,
                        ...
                        p = this.outside,
                        B = p
                            ? n.documentElement.clientWidth - 2 * d
                            : g.chartWidth,
                        M = p
                            ? Math.max(
                                  n.body.scrollHeight,
                        ...
                        q =
                            !this.followPointer &&
                            E(k.ttBelow, !g.inverted === !!k.negative),
                        u = function (b, g, k, a, l, m, r) {
                            ...
                            if (q && B) h[b] = l;
                                ...
                                h[b] = Math.min(r - a, 0 > z - f ? z : z - f);
                            else if (B)
                                h[b] = Math.max(m, l + f + k > g ? l : l + f);
                            else return !1;
                        },
                ...
                m.prototype.refresh = function (h, l) {
                    ...
                    if (g.enabled) {
                        a.clearTimeout(this.hideTimer);
                        this.followPointer =
                            p(d)[0].series.tooltipOptions.followPointer;
                ...
                m.prototype.renderSplit = function (a, l) {
                    ...
                    a = a.slice(0, l.length + 1).reduce(function (e, d, a) {
                        if (!1 !== d && "" !== d) {
                            ...
                            var A =
                                "highcharts-color-" +
                                E(a.colorIndex, B.colorIndex, "none");
                            r ||
                                ((r = {
                                    padding: w.padding,
                                    r: w.borderRadius,
        ...
        function (f, a, n, y) {
            ...
            f = (function () {
                ...
                l.prototype.destroy = function () {
                    var k = this;
                    "undefined" !== typeof k.unDocMouseMove &&
                        k.unDocMouseMove();
                ...
                l.prototype.getChartPosition = function () {
                    return (
                        this.chartPosition ||
                        (this.chartPosition = u(this.chart.container))
                    );
                };
                ...
                l.prototype.getHoverData = function (a, g, d, h, l, f) {
                    ...
                    g =
                        (k = h || !f ? a : this.findNearestKDPoint(p, l, f)) &&
                        k.series;
                    k &&
                        (l && !g.noSharedTooltip
                ...
                l.prototype.init = function (a, g) {
                    ...
                    this.chart = a;
                    this.runChartClick =
                        g.chart.events && !!g.chart.events.click;
                    this.pinchDown = [];
                    this.lastValidTouch = {};
                    n &&
                        ((a.tooltip = new n(a, g.tooltip)),
                        (this.followTouchMove = m(
                            g.tooltip.followTouchMove,
                            !0,
                        )));
                    this.setDOMEvents();
                };
                          ...
                          d.axes.forEach(function (c) {
                              if (c.zoomEnabled) {
                                  var b = d.bounds[c.horiz ? "h" : "v"],
                                      ...
                                      g = c.toPixels(
                                          Math.min(
                                              m(c.options.min, c.dataMin),
                                              c.dataMin,
                                          ),
                                      ),
                                      a = c.toPixels(
                                          Math.max(
                                              m(c.options.max, c.dataMax),
                                              c.dataMax,
                                          ),
                                      ),
                                      h = Math.max(g, a);
                ...
                l.prototype.pinchTranslate = function (a, g, d, h, l, f) {
                    this.zoomHor &&
                        this.pinchTranslateDirection(!0, a, g, d, h, l, f);
                    this.zoomVert &&
                        this.pinchTranslateDirection(!1, a, g, d, h, l, f);
                };
                                ...
                                ? f.forEach(function (d) {
                                      ...
                                      d.series.isCartesian &&
                                          (d.series.xAxis.crosshair &&
                                              d.series.xAxis.drawCrosshair(
                                                  null,
                                                  d,
                                              ),
                                          d.series.yAxis.crosshair &&
                                              d.series.yAxis.drawCrosshair(
                                                  null,
                                                  d,
                                              ));
                                  })
                ...
                l = (function () {
                    ...
                    a.prototype.renderItem = function (a) {
                        ...
                        e ||
                            ...
                            (this.symbolHeight =
                                h.symbolHeight || this.fontMetrics.f),
                    ...
                    a.prototype.getAllItems = function () {
                        ...
                        this.chart.series.forEach(function (d) {
                            ...
                            d &&
                                K(
                                    g.showInLegend,
                                    G(g.linkedTo) ? !1 : void 0,
                                    !0,
                                ) &&
                                (a = a.concat(
                                    d.legendItems ||
                                        ("point" === g.legendType ? d.data : d),
                                ));
                        });
                    ...
                    a.prototype.proximatePositions = function () {
                        ...
                        d.forEach(function (d) {
                            d.item._legendItemPos[1] =
                                a.plotTop - a.spacing[0] + d.pos;
                        });
                    };
                        ...
                        var m = k.maxHeight,
                            ...
                            v = function (c) {
                                d[c] = h
                                    ...
                                    .add(z);
                                g.styledMode ||
                                    d[c].attr("fill", "rgba(0,0,0,0.0001)");
                                return d[c];
                            };
                        "horizontal" !== k.layout ||
                ...
                Y = (function () {
                    ...
                    D.prototype.init = function (d, g) {
                        ...
                        r(this, "init", { args: arguments }, function () {
                            ...
                            this.series = [];
                            this.time =
                                d.time && Object.keys(d.time).length
                                    ? new C(d.time)
                                    : a.time;
                    ...
                    D.prototype.redraw = function (b) {
                        ...
                        a.forEach(function (b) {
                            b.isDirty &&
                                ("point" === b.options.legendType
                                    ? (b.updateTotals && b.updateTotals(),
                                      (l = !0))
                                    : k &&
                                      (k.labelFormatter || k.labelFormat) &&
                                      (l = !0));
                        ...
                        l &&
                            h &&
                            h.options.enabled &&
                            (h.render(), (c.isDirtyLegend = !1));
                        B && c.getStacks();
                        f &&
                            e.forEach(function (b) {
                                (c.isResizing && M(b.min)) ||
                                    (b.updateNames(), b.setScale());
                            });
                        c.getMargins();
                        f &&
                            (e.forEach(function (b) {
                    ...
                    D.prototype.get = function (b) {
                        function c(c) {
                            return (
                                c.id === b || (c.options && c.options.id === b)
                            );
                        }
                        var e = this.series,
                            d;
                    ...
                    D.prototype.temporaryDisplay = function (b) {
                        ...
                        if (b)
                            for (; c && c.style; )
                                (c.hcOrigStyle &&
                                    (m(c, c.hcOrigStyle), delete c.hcOrigStyle),
                                    c.hcOrigDetached &&
                                        (v.body.removeChild(c),
                                        (c.hcOrigDetached = !1)),
                                    (c = c.parentNode));
                        else
                            for (; c && c.style; ) {
                    ...
                    D.prototype.setChartSize = function (b) {
                        ...
                        this.clipBox = {
                            ...
                            y: e,
                            width: Math.floor(
                                this.plotSizeX - Math.max(d, k[1]) / 2 - c,
                            ),
                            height: Math.max(
                                0,
                                Math.floor(
                                    this.plotSizeY - Math.max(d, k[2]) / 2 - e,
                                ),
                            ),
                        };
                        b ||
                    ...
                    D.prototype.firstRender = function () {
                        ...
                        if (!b.isReadyToRender || b.isReadyToRender()) {
                            ...
                            G &&
                                (b.pointer =
                                    a.hasTouch ||
                                    (!q.PointerEvent && !q.MSPointerEvent)
                                        ? new G(b, c)
                                        : new y(b, c));
                            b.render();
        ...
        function (f, a, n) {
            ...
            y(f, "afterSetChartSize", function (f) {
                ...
                if (!this.renderer.forExport) {
                    if (v) {
                        if (
                            (this.scrollablePixelsX = v =
                                Math.max(0, v - this.chartWidth))
                        ) {
                            this.plotWidth += v;
                            this.inverted
                                ? ((this.clipBox.height += v),
                                  (this.plotBox.height += v))
                                : ((this.clipBox.width += v),
                                  (this.plotBox.width += v));
                        ...
                        this.axes.forEach(function (f) {
                            C[f.side]
                                ? (f.getPlotLinePath = function () {
                                      ...
                                      var p =
                                          a.Axis.prototype.getPlotLinePath.apply(
                                              this,
                                              arguments,
                                          );
                                      this[q] = n;
        ...
        function (f, a) {
            ...
            a = (function () {
                ...
                a.prototype.getGraphicalProps = function (a) {
                    ...
                    a.dataLabel &&
                        h.push("dataLabel", "dataLabelUpper", "connector");
                    for (l = h.length; l--; ) {
                        var g = h[l];
                ...
                a.prototype.tooltipFormatter = function (a) {
                    var f = this.series,
                        ...
                        g = h.valueSuffix || "";
                    f.chart.styledMode &&
                        (a = f.chart.tooltip.styledModeFormat(a));
                ...
                },
                {
                    ...
                    setOptions: function (e) {
                        ...
                        d = x(
                            h,
                            a.series,
                            d.plotOptions && d.plotOptions[this.type],
                            e,
                        );
                        this.tooltipOptions = x(
                            C.tooltip,
                            C.plotOptions.series &&
                                C.plotOptions.series.tooltip,
                        ...
                        for (r = 0; r < k; r++) {
                            ...
                            if (
                                (h.positiveValuesOnly &&
                                    !h.validatePositiveValue(C)) ||
                                (b.positiveValuesOnly &&
                                    !b.validatePositiveValue(I))
                            )
                                u.isNull = !0;
                            u.plotX = F = K(
                                q(
                            ...
                            u.clientX = B
                                ? K(b.translate(I, 0, 0, 0, 1, t))
                                : F;
                            u.negative = u[M] < (e[M + "Threshold"] || n || 0);
                            u.category =
                                a && "undefined" !== typeof a[u.x]
                                    ? a[u.x]
                                    : u.x;
                            if (!u.isNull && !1 !== u.visible) {
                                "undefined" !== typeof G &&
                                    (v = Math.min(v, Math.abs(F - G)));
                                var G = F;
                            }
                    ...
                    getValidPoints: function (e, c, b) {
                        ...
                        return (e || this.points || []).filter(function (e) {
                            return c &&
                                !a.isInsidePlot(e.plotX, e.plotY, a.inverted)
                                ? !1
                    ...
                    drawPoints: function () {
                        ...
                        if (!1 !== d.enabled || this._hasPointMarkers)
                            for (b = 0; b < e.length; b++) {
                                ...
                                var p = !!k.marker;
                                if (
                                    ((f && "undefined" === typeof m.enabled) ||
                                        m.enabled) &&
                                    !k.isNull &&
                                    !1 !== k.visible
                                ) {
                                    var r = A(m.symbol, this.symbol);
                                    var t = this.markerAttribs(
                                        k,
                                        k.selected && "select",
                                    );
                                    this.enabledDataSorting &&
                                        (k.startXPos = h.reversed
                                            ? -t.width
                                            : h.width);
                                    var B = !1 !== k.isInside;
                                    a
                    ...
                    drawGraph: function () {
                        var e = this,
                            c = this.options,
                            b = (this.gappedPath || this.getGraphPath).call(
                                this,
                            ),
                            a = this.chart.styledMode,
                        ...
                        d.forEach(function (d, g) {
                            var h = d[0],
                                ...
                                k = f ? "animate" : "attr";
                            f
                                ? ((f.endX = e.preventGraphAnimation
                                      ? null
                                      : b.xMap),
                                  f.animate({ d: b }))
                                : b.length &&
                    ...
                    applyZones: function () {
                        ...
                        if (
                            ...
                            d.forEach(function (e, d) {
                                ...
                                h = q(
                                    Math.round(
                                        r.toPixels(A(e.value, E.max), !0) || 0,
                                    ),
                                    0,
                                    p,
                                );
                    ...
                    buildKDTree: function (a) {
                        ...
                        M(
                            ...
                            b.options.kdNow || (a && "touchstart" === a.type)
                                ? 0
                                : 1,
                        );
                    },
                    searchKDTree: function (a, c, b) {
                        ...
                        var e = this,
                            ...
                            f = c ? "distX" : "dist";
                        c =
                            -1 < e.options.findNearestPointBy.indexOf("y")
                                ? 2
                                : 1;
                        this.kdTree ||
                            this.buildingKdTree ||
                ...
                K = (function () {
                    function a(a, f, n, q, m) {
                        ...
                        this.alignOptions = {
                            align:
                                f.align ||
                                (h ? (n ? "left" : "right") : "center"),
                            verticalAlign:
                                f.verticalAlign ||
                                (h ? "middle" : n ? "bottom" : "top"),
                            y: f.y,
                            x: f.x,
                        };
                        this.textAlign =
                            f.textAlign ||
                            (h ? (n ? "right" : "left") : "center");
                    }
                    a.prototype.destroy = function () {
                        J(this, this.axis);
                    };
            ...
            q.prototype.setStackedPoints = function (a) {
                ...
                if (
                    ...
                    for (B = 0; B < m; B++) {
                        ...
                        c = r[c][M];
                        null !== E
                            ? ((c.points[e] = c.points[this.index] =
                                  [L(c.cumulative, k)]),
        ...
        function (f, a, n, y, D, G, C) {
            ...
            t(a.prototype, {
                ...
                update: function (a, h, f, p) {
                    ...
                    g(a, function (b, a) {
                        if (e[a] && "function" === typeof e[a].update)
                            e[a].update(b, !1);
            ...
            t(D.prototype, {
                update: function (a, g, f, k) {
                    ...
                    !1 === k
                        ? e()
                        : c.firePointEvent("update", { options: a }, e);
                },
                remove: function (a, d) {
            ...
            t(y.prototype, {
                ...
                update: function (a, g) {
                    ...
                    l &&
                        ...
                        a.data &&
                            (a.dataSorting &&
                                t(h.options.dataSorting, a.dataSorting),
                    ...
                    getStackPoints: function (a) {
                        ...
                        if (this.options.stacking) {
                            for (h = 0; h < a.length; h++)
                                ((a[h].leftNull = a[h].rightNull = void 0),
                                    (p[a[h].x] = a[h]));
                            G(E, function (a, g) {
                    ...
                    drawGraph: function () {
                        ...
                        q.forEach(function (q) {
                            var v = q[0],
                                ...
                                I = {};
                            p
                                ? ((p.endX = a.preventGraphAnimation
                                      ? null
                                      : f.xMap),
                                  p.animate({ d: f }))
                                : ((I.zIndex = 0),
                            ...
                            a.chart.styledMode ||
                                (I.fill = C(
                                    q[3],
                                    D(q[2])
                                        .setOpacity(C(n.fillOpacity, 0.75))
                                        .get(),
                                ));
                            p[t](I);
                            p.startX = f.xMap;
                ...
                getPointSpline: function (f, n, D) {
                    ...
                    if (
                        ...
                        q > f && q > C
                            ...
                            : q < f &&
                              q < C &&
                              ((q = Math.min(f, C)), (K = 2 * C - q));
                        K > D && K > C
                            ? ((K = Math.max(D, C)), (q = 2 * C - K))
                            : K < D &&
                              K < C &&
                              ((K = Math.min(D, C)), (q = 2 * C - K));
                        n.rightContX = H;
                        n.rightContY = K;
                    }
                    n = [
                ...
                },
                {
                    ...
                    translate: function () {
                        ...
                        a.points.forEach(function (p) {
                            ...
                            J(p.options.pointWidth) &&
                                ...
                                (b -= Math.round((e - x) / 2)));
                            n.centerInCategory &&
                                (b = a.adjustForMissingColumns(b, e, p, d));
                            p.barX = b;
                            p.pointWidth = e;
                    ...
                    animate: function (a) {
                        ...
                        if (a)
                            ((h.scaleY = 0.001),
                                (a = C(
                                    p.toPixels(n.threshold),
                                    p.pos,
                                    p.pos + p.len,
                                )),
                                m
                                    ? (h.translateX = a - p.len)
                                    : (h.translateY = a),
                                f.clipBox && f.setClip(),
                                f.group.attr(h));
                        else {
            ...
            p(
                ...
                },
                {
                    ...
                    drawPoints: function () {
                        ...
                        this.points.forEach(function (f) {
                            ...
                            f.graphic ||
                                ((f.graphic = a[f.shapeType](f.shapeArgs).add(
                                    f.series.group,
                                )),
                ...
                },
                {
                    ...
                    slice: function (a, f, l) {
                        ...
                        t(l, h.chart);
                        K(f, !0);
                        this.sliced = this.options.sliced = H(a)
                            ? a
                            : !this.sliced;
        ...
        function (f, a) {
            ...
            m.prototype.drawDataLabels = function () {
                ...
                function f(a, d) {
                    ...
                    if (q(a) && !q(d))
                        ...
                        for (b = Math.max(a.length, d.length); b--; )
                            c[b] = K(a[b], d[b]);
                    else c = K(a, d);
                    return c;
                }
                    ...
                    n.forEach(function (h) {
                        t = I(
                            f(
                                m,
                                h.dlOptions ||
                                    (h.options && h.options.dataLabels),
                            ),
                        );
                        t.forEach(function (e, c) {
                            ...
                            if (b) {
                                ...
                                var q = p(
                                    e[h.formatPrefix + "Format"],
                                    e.format,
                                );
                                r = C(q)
                                    ? v(q, r, g)
                                    : (
                                          e[h.formatPrefix + "Formatter"] ||
                                          e.formatter
                                      ).call(r, e);
                                q = e.style;
                                var t = e.rotation;
            ...
            m.prototype.setDataLabelStartPos = function (a, f, k, g, d) {
                ...
                g
                    ...
                    : f
                          .attr({ opacity: 1 })
                          .animate({ opacity: 0 }, void 0, f.hide);
                h.hasRendered &&
                    (k && f.attr({ x: f.startXPos, y: f.startYPos }),
                    (f.placed = !0));
            };
            ...
            y.pie &&
                ...
                (y.pie.prototype.verifyDataLabelOverflow = function (a) {
                    ...
                    if (!m) {
                        if (null !== g[0])
                            var n = Math.max(f[2] - Math.max(a[1], a[3]), d);
                        else
            ...
            y.column &&
                (y.column.prototype.alignDataLabel = function (a, f, k, g, d) {
                    var h = this.chart.inverted,
                        ...
                        q = p(
                            a.below,
                            a.plotY > p(this.translatedThreshold, l.yAxis.len),
                        ),
                ...
                for (E = 0; E < n; E++) {
                    ...
                    for (C = E + 1; C < n; ++C) {
                        ...
                        !u ||
                            ...
                            m.y >= u.y + u.height ||
                            m.y + m.height <= u.y ||
                            ((D.labelrank < p.labelrank ? D : p).newOpacity =
                                0);
                    }
                }
                a.forEach(function (a) {
        ...
        function (f, a, n, y, D, G) {
            ...
            q(n.prototype, {
                setItemEvents: function (a, f, g) {
                    ...
                    (g ? [f, a.legendSymbol] : [a.legendGroup]).forEach(
                        function (g) {
                            if (g)
            ...
            q(f.prototype, {
                ...
                pan: function (d, f) {
                    var g = this,
                        ...
                        k = g.options.chart,
                        l =
                            g.options.mapNavigation &&
                            g.options.mapNavigation.enabled,
                        m;
                        ...
                        f.forEach(function (e) {
                            ...
                            p = Math.min(
                                ...
                                k
                                    ? q.min
                                    : c.toValue(
                                          c.toPixels(q.min) - c.minPixelPadding,
                                      ),
                            );
                            k = Math.max(
                                a.pick(
                                ...
                                k
                                    ? q.max
                                    : c.toValue(
                                          c.toPixels(q.max) + c.minPixelPadding,
                                      ),
                            );
                            c.panningState = x;
                            c.isOrdinal ||
                ...
                setState: function (a, f) {
                    ...
                    if (
                        ...
                        a && a.size && e && "hidden" !== k && !this.isCluster
                            ? (t ||
                                  (d.halo = t =
                                      b.renderer.path().add(e.parentGroup)),
                              t
                                  .show()
                                  [
                                      f ? "animate" : "attr"
            ...
            q(y.prototype, {
                ...
                setState: function (a, f) {
                    ...
                    if (
                        d.state !== a &&
                        ([d.group, d.markerGroup, d.dataLabelsGroup].forEach(
                            function (c) {
                                c &&
                                    (d.state &&
                                        c.removeClass(
                                            "highcharts-series-" + d.state,
                                        ),
            ...
            f.prototype.matchResponsiveRule = function (a, f) {
                ...
                (
                    ...
                    function () {
                        return (
                            this.chartWidth <=
                                J(n.maxWidth, Number.MAX_VALUE) &&
                            this.chartHeight <=
                                J(n.maxHeight, Number.MAX_VALUE) &&
