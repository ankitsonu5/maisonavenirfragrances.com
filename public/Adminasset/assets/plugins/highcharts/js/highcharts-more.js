...
(function (d) {
    ...
    C(
        ...
        function (d, a, g, h, b) {
            function r(m, l, e) {
                return (
                    Math.sqrt(Math.pow(m - e[0], 2) + Math.pow(l - e[1], 2)) <=
                    e[2] / 2
                );
            }
            var t = h.addEvent,
            ...
            h = (function () {
                        ...
                        for (
                            ...
                            e[a] && this.axis
                                ? this.renderBackground(
                                      B(this.defaultBackgroundOptions, e[a]),
                                      a,
                                  )
                                : this.background[a] &&
                                  ((this.background[a] =
                ...
                m.prototype.updateCenter = function (m) {
                    this.center = (m || this.axis || {}).center =
            ...
            a.Chart.prototype.getHoverPane = function (m) {
                ...
                m &&
                    l.pane.forEach(function (e) {
                        ...
                        r(l.inverted ? k : b, l.inverted ? b : k, e.center) &&
                            (a = e);
                    });
                return a;
            };
                ...
                a.init = function (a) {
                    ...
                    a.getLinePath = function (k, p, c) {
                        ...
                        this.isCircular || "undefined" !== typeof p
                            ? ((p = this.chart.renderer.symbols.arc(
                                  this.left + k[0],
                                  this.top + k[1],
                                  n,
                                  n,
                            ...
                            : ((p = this.postTranslate(this.angleRad, n)),
                              (p = [
                                  [
                                      "M",
                                      this.center[0] + f.plotLeft,
                                      this.center[1] + f.plotTop,
                                  ],
                                  ["L", p.x, p.y],
                              ]));
                        return p;
                    ...
                    a.beforeSetTickPositions = function () {
                        this.autoConnect =
                            this.isCircular &&
                            "undefined" ===
                                typeof l(this.userMax, this.options.max) &&
                            r(this.endAngleRad - this.startAngleRad) ===
                                r(2 * Math.PI);
                    ...
                    a.getPlotBandPath = function (k, p, c) {
                        ...
                        if ("polygon" === this.options.gridLineInterpolation)
                            ...
                            a -= q;
                            q = this.chart.renderer.symbols.arc(
                                this.left + n[0],
                                this.top + n[1],
                                a,
                                a,
                            ...
                            m &&
                                ...
                                (q.xBounds =
                                    m > -Math.PI / 2 && m < Math.PI / 2
                                        ? [e, this.chart.plotWidth]
                                        : [0, e]),
                                (q.yBounds = [
                                    this.top + n[1] + (n[2] / 2) * Math.sin(m),
                                ]),
                                (q.yBounds[0] +=
                                    (m > -Math.PI && 0 > m) || m > Math.PI
                                        ? -10
                                        : 10));
                        }
                        return q;
                    ...
                    a.getPlotLinePath = function (k) {
                        ...
                        var v;
                        k.isCrosshair &&
                            ((h = this.getCrosshairPosition(k, D, b)),
                            (u = h[0]),
                            (e = h[1]),
                            (h = h[2]));
                        if (p.isCircular)
                            ((u = Math.sqrt(
                                Math.pow(e - D, 2) + Math.pow(h - b, 2),
                            )),
                            ...
                            for (
                                ...
                                ((b = v.getPosition(D[e], u)),
                                    c.push(
                                        e ? ["L", b.x, b.y] : ["M", b.x, b.y],
                                    ));
                        return c;
                    };
                    ...
                    a.createLabelCollector = function () {
                        ...
                        return function () {
                            if (
                                k.isRadial &&
                                k.tickPositions &&
                                !0 !== k.options.labels.allowOverlap
                            )
                ...
                a.compose = function (e, h) {
                                ...
                                n &&
                                    ...
                                    c &&
                                        ...
                                        (this.defaultPolarOptions.stackLabels =
                                            e.defaultYAxisOptions.stackLabels));
                            f || n
                                ? ((this.isRadial = !0),
                    ...
                    b(e, "afterInit", function () {
                        ...
                        (k.angular && this.isXAxis) ||
                            ...
                            (this.startAngleRad =
                                ((f.startAngle - 90) * Math.PI) / 180),
                            (this.endAngleRad =
                                ((l(f.endAngle, f.startAngle + 360) - 90) *
                                    Math.PI) /
                                180),
                    ...
                    b(e, "autoLabelAlign", function (k) {
                        this.isRadial &&
                            ((k.align = void 0), k.preventDefault());
                    });
                    ...
                    b(h, "afterGetPosition", function (k) {
                        this.axis.getPosition &&
                            x(k.pos, this.axis.getPosition(this.pos));
                    });
                        ...
                        if (c) {
                            ...
                            if (p.isRadial) {
                                ...
                                "auto" === n.rotation
                                    ...
                                    : null === u &&
                                      (u =
                                          p.chart.renderer.fontMetrics(
                                              c.styles && c.styles.fontSize,
                                          ).b -
                                          f.height / 2);
                                null === q &&
                                    (p.isCircular
                                        ? (f.width >
                                              (p.len * p.tickInterval) /
                                                  (p.max - p.min) && (A = 0),
                                          (q =
                                              a > A && a < 180 - A
                                                  ? "left"
                ...
                },
                {
                    ...
                    translate: function () {
                        ...
                        m.points.forEach(function (e) {
                            ...
                            e.isNull
                                ? (e.plotY = null)
                                : ((e.plotLow = k),
                                  (e.plotHigh = a.translate(
                                      l ? m.modifyValue(b, e) : b,
                                      0,
                                      1,
                                      0,
                                      1,
                        ...
                        this.chart.polar &&
                            this.points.forEach(function (a) {
                                m.highToXY(a);
                                a.tooltipPos = [
                                    (a.plotHighX + a.plotLowX) / 2,
                                    (a.plotHigh + a.plotLow) / 2,
                                ];
                            });
                    },
                    ...
                    drawDataLabels: function () {
                        ...
                        if (c.enabled || this._hasPointLabels) {
                            ...
                            z.drawDataLabels &&
                                z.drawDataLabels.apply(this, arguments);
                            for (e = l; e--; )
                                if ((k = a[e]))
                    ...
                    alignDataLabel: function () {
                        B.column.prototype.alignDataLabel.apply(
                            this,
                            arguments,
                        );
                    },
                ...
                },
                {
                    setState: function () {
                        var a = this.state,
                            ...
                            e = b.chart.polar;
                        h(this.plotHigh) ||
                            (this.plotHigh = b.yAxis.toPixels(this.high, !0));
                        h(this.plotLow) ||
                            (this.plotLow = this.plotY =
                                b.yAxis.toPixels(this.low, !0));
                    ...
                    haloPath: function () {
                        ...
                        this.isInside &&
                            (b = l.haloPath.apply(this, arguments));
                        this.plotY = this.plotHigh;
                        a && (this.plotX = this.plotHighX);
                        this.isTopInside &&
                            (b = b.concat(l.haloPath.apply(this, arguments)));
                        return b;
                    },
                    ...
                    translate: function () {
                        ...
                        a.points.forEach(function (p) {
                            ...
                            "percent" === x.stacking &&
                                (n = l + (0 > p.y) ? -100 : 100);
                            n = z.toPixels(n, !0);
                            var b = (q = d.plotHeight - n - (d.plotHeight - m))
                                ? (u * (A - n)) / q
                                : 0;
                            var e = q ? (u * (A + c - n)) / q : 0;
                            q = f - b + u;
    ...
    C(
        ...
        function (d, a, g, h, b, r) {
            ...
            (function (a) {
                ...
                function f() {
                    for (
                        var c = this.axes, f = this.series, n = f.length;
                        n--;
                    )
            ...
            r(
                ...
                },
                {
                                ...
                                if (q) {
                                    ...
                                    if ("overlap" === A) {
                                        ...
                                        Object.hasOwnProperty.call(
                                            r,
                                            "absolutePos",
                                        ) && delete r.absolutePos;
                                        Object.hasOwnProperty.call(
                                            r,
                                            "absoluteNeg",
                                        ) && delete r.absoluteNeg;
                                    } else
                                        (0 <= t
                                            ? ((w = r.threshold + r.posTotal),
                                              (r.posTotal -= t))
                                            : ((w = r.threshold + r.negTotal),
                                              (r.negTotal -= t),
                                              (w -= t)),
                                            !r.posTotal &&
                                                Object.hasOwnProperty.call(
                                            ...
                                            !r.negTotal &&
                                                ...
                                                ((r.negTotal = r.absoluteNeg),
                                                delete r.absoluteNeg));
                                    e.isSum ||
                                        (r.connectorThreshold =
                                            r.threshold + r.stackTotal);
                                    b.reversed
                                        ? ((g = 0 <= t ? w - t : w + t),
                                          (t = w))
                                        : ((g = w), (t = w - t));
                                    ...
                                    e.isSum
                                        ...
                                        : e.isIntermediateSum
                                          ...
                                          : ((d.height =
                                            ...
                                            (e.below = l < v(u, 0))),
                                    0 > d.height &&
                                        ((d.y += d.height), (d.height *= -1)));
                            e.plotY = d.y =
                                Math.round(d.y) - (this.borderWidth % 2) / 2;
                    ...
                    processData: function (a) {
                        ...
                        b.stacking ||
                            ((this.dataMin = l + u), (this.dataMax = k));
                    },
                    toYData: function (a) {
                        return a.isSum
                            ? "sum"
                    ...
                    getCrispPath: function () {
                        ...
                        for (e = 1; e < c; e++) {
                            ...
                            r &&
                                ...
                                q
                                    ? ((r = r.connectorThreshold),
                                      (t =
                                          Math.round(
                                              b.translate(r, 0, 1, 0, 1) +
                                                  (l ? t : 0),
                                          ) - f))
                                    : (t =
                                          d.y + g.minPointLengthOffset + n - f),
                                m.push(
                                    [
                                        "M",
                                        (d.x || 0) + (u ? 0 : d.width || 0),
                            ...
                            !q &&
                                ...
                                d &&
                                ((0 > g.y && !l) || (0 < g.y && l)) &&
                                ((m[m.length - 2][2] += d.height),
                                (m[m.length - 1][2] += d.height));
                        }
                        return m;
                    },
                    drawGraph: function () {
                ...
                },
                {
                    ...
                    isValid: function () {
                        return (
                            l(this.y) || this.isSum || !!this.isIntermediateSum
                        );
                    },
                },
            );
        ...
        function (d, a, g) {
            ...
            g(
                ...
                },
                {
                    ...
                    getGraphPath: function () {
                        for (
                            var a = h.prototype.getGraphPath.call(this),
                                b = a.length + 1;
                            b--;
                        )
                            (b === a.length || "M" === a[b][0]) &&
        ...
        function (d, a, g, h, b) {
            ...
            v = (function () {
                ...
                a.prototype.drawLegendSymbol = function (c) {
                    ...
                    this.fontMetrics = f.renderer.fontMetrics(
                        a.labels.style.fontSize.toString() + "px",
                    );
                    ...
                    c.forEach(function (n, u) {
                        g ||
                            ...
                            (l.fill = m(
                                ...
                                f.color,
                                1 !== h
                                    ? r(a.color).setOpacity(h).get("rgba")
                                    : a.color,
                            )),
                            (q.stroke = m(
                                n.connectorColor,
                ...
                a.prototype.renderRange = function (c) {
                    ...
                    "center" === g &&
                        ((h = 0),
                        (f.connectorDistance = 0),
                        (c.labelStyle.align = "center"));
                    g = p + f.labels.y;
                            ...
                            a.length &&
                                ((b = m(
                                    ...
                                    Math.min(
                                        ...
                                        Math.max(
                                            x(a),
                                            !1 === c.options.displayNegative
                                                ? c.options.zThreshold
                                                : -Number.MAX_VALUE,
                                        ),
                                    ),
                                )),
            ...
            h.prototype.getLinesHeights = function () {
                ...
                for (n = 0; n < f; n++)
                    if (
                        (a[n].legendItemHeight &&
                            (a[n].itemHeight = a[n].legendItemHeight),
                        a[n] === a[f - 1] ||
                            (a[n + 1] &&
                                a[n]._legendItemPos[1] !==
                                    a[n + 1]._legendItemPos[1]))
                    ) {
                        c.push({ height: 0 });
                        var l = c[c.length - 1];
                        for (b; b <= n; b++)
                            a[b].itemHeight > l.height &&
                                (l.height = a[b].itemHeight);
                        l.step = n;
                    }
                return c;
            };
            h.prototype.retranslateItems = function (a) {
                ...
                this.allItems.forEach(function (q, u) {
                    ...
                    if ((n = q.movementX) || (b && q.ranges))
                        ((n = b ? c - q.options.maxSize / 2 : c + n),
                            q.legendGroup.attr({ translateX: n }));
                    u > a[l].step && l++;
                    q.legendGroup.attr({
            ...
            y(d.prototype, "drawChartBox", function (a, c, f) {
                ...
                if (
                    ...
                    n.options.enabled &&
                    n.bubbleLegend &&
                    n.options.bubbleLegend.autoRanges &&
                    b
                ) {
            ...
            a(
                ...
                },
                {
                    ...
                    pointAttribs: function (a, l) {
                        ...
                        1 !== m &&
                            (a.fill = b(a.fill).setOpacity(m).get("rgba"));
                        return a;
                    },
            ...
            h.prototype.beforePadding = function () {
                ...
                F.length &&
                    ...
                    [
                        ...
                        "undefined" === typeof l(a.options[c[0]], a[c[1]]) &&
                            (a[c[0]] += c[2] / B);
                    }));
            };
            ("");
                    ...
                    (g = h(a.container, "mousedown", function (b) {
                        ...
                        g &&
                            ...
                            (d = h(a.container, "mousemove", function (a) {
                                return (
                                    g && g.series && g.series.onMouseMove(g, a)
                                );
                            })),
                            (x = h(
            ...
            d.networkgraphIntegrations = {
                verlet: {
                    ...
                    barycenter: function () {
                        ...
                        this.nodes.forEach(function (a) {
                            a.fixedPosition ||
                                ((a.plotX -= g / a.mass / a.degree),
                                (a.plotY -= h / a.mass / a.degree));
                        });
                    },
                    repulsive: function (a, g, h) {
                        g = (g * this.diffTemperature) / a.mass / a.degree;
                        a.fixedPosition ||
                            ((a.plotX += h.x * g), (a.plotY += h.y * g));
                    },
                    attractive: function (a, g, h) {
                        ...
                        a.fromNode.fixedPosition ||
                            ((a.fromNode.plotX -=
                                (d * b.fromNode) / a.fromNode.degree),
                            (a.fromNode.plotY -=
                                (g * b.fromNode) / a.fromNode.degree));
                        a.toNode.fixedPosition ||
                            ((a.toNode.plotX +=
                                (d * b.toNode) / a.toNode.degree),
                            (a.toNode.plotY +=
                                (g * b.toNode) / a.toNode.degree));
                    },
                ...
                euler: {
                    ...
                    attractive: function (a, g, h, b) {
                        ...
                        a.fromNode.fixedPosition ||
                            ((a.fromNode.dispX -=
                                (t * d.fromNode) / a.fromNode.degree),
                            (a.fromNode.dispY -=
                                (g * d.fromNode) / a.fromNode.degree));
                        a.toNode.fixedPosition ||
                            ((a.toNode.dispX +=
                                (t * d.toNode) / a.toNode.degree),
                            (a.toNode.dispY +=
                                (g * d.toNode) / a.toNode.degree));
                    },
                    integrate: function (a, d) {
                        ...
                        0 !== h &&
                            ((d.plotX +=
                                (d.dispX / h) *
                                Math.min(Math.abs(d.dispX), a.temperature)),
                            (d.plotY +=
                                (d.dispY / h) *
                                Math.min(Math.abs(d.dispY), a.temperature)));
                    },
                    getK: function (a) {
                        return Math.pow(
                            (a.box.width * a.box.height) / a.nodes.length,
                              ...
                              ? b
                                  ? ((this.isInternal = !0),
                                    ...
                                    !0 !== this.body &&
                                        ...
                                        ].insert(this.body, b - 1),
                                        (this.body = !0)),
                                    this.nodes[this.getBoxPosition(a)].insert(
                                        a,
                                        b - 1,
                                    ))
                                  : ((b = new g({
        ...
        function (d, a, g) {
            ...
            t(a.layouts["reingold-fruchterman"].prototype, {
                init: function (b) {
                    ...
                    this.integration =
                        a.networkgraphIntegrations[b.integration];
                    this.enableSimulation = b.enableSimulation;
                    this.attractiveForce = B(
                        b.attractiveForce,
                        this.integration.attractiveForceFunction,
                    );
                    this.repulsiveForce = B(
                        b.repulsiveForce,
                ...
                step: function () {
                    ...
                    "barnes-hut" === b.approximation &&
                        (b.createQuadTree(),
                        b.quadTree.calculateMassAndCenter());
                    ...
                    b.enableSimulation &&
                        ...
                        !b.isStable()
                            ? (b.simulation &&
                                  a.win.cancelAnimationFrame(b.simulation),
                              (b.simulation = a.win.requestAnimationFrame(
                                  function () {
                                      b.step();
                                  },
                              )))
                ...
                stop: function () {
                    this.simulation &&
                        a.win.cancelAnimationFrame(this.simulation);
                },
                ...
                setCircularPositions: function () {
                    ...
                    h.forEach(function (a, f) {
                        a.plotX = a.prevX = B(
                            a.plotX,
                            b.width / 2 + p * Math.cos(f * e),
                        );
                        a.plotY = a.prevY = B(
                            a.plotY,
                            b.height / 2 + p * Math.sin(f * e),
                        );
                        a.dispX = 0;
                        a.dispY = 0;
                    });
                ...
                barnesHutApproximation: function (a, b) {
                    ...
                    if (a !== b && 0 !== e)
                        if (b.isInternal)
                            ...
                            ((l = this.repulsiveForce(e, this.k)),
                                this.force("repulsive", a, l * b.mass, d, e));
                    return g;
                },
                ...
                attractiveForces: function () {
                    ...
                    a.links.forEach(function (g) {
                        g.fromNode &&
                            ...
                            (d = a.vectorLength(b)),
                            0 !== d &&
                                ((e = a.attractiveForce(d, a.k)),
                                a.force("attractive", g, e, b, d)));
                    });
                },
                ...
                barycenter: function () {
                    ...
                    d.forEach(function (c) {
                        a.options.splitSeries && !c.isParentNode
                            ? ((e = c.series.parentNode.plotX),
                              (q = c.series.parentNode.plotY))
                            : ((e = b.width / 2), (q = b.height / 2));
                        c.fixedPosition ||
                            ((c.plotX -=
                                ((c.plotX - e) * f) /
                                (c.mass * Math.sqrt(d.length))),
                            (c.plotY -=
                                ((c.plotY - q) * f) /
                                (c.mass * Math.sqrt(d.length))));
                    });
            ...
            g.layouts.packedbubble = a(k, {
                ...
                setCircularPositions: function () {
                    ...
                    b.forEach(function (c, b) {
                        ...
                        c.plotX = c.prevX = y(
                            c.plotX,
                            e + g * Math.cos(c.index || b * d),
                        );
                        c.plotY = c.prevY = y(
                            c.plotY,
                            q + g * Math.sin(c.index || b * d),
                        );
                        c.dispX = 0;
                        c.dispY = 0;
                    });
                    ...
                    a.nodes.forEach(function (c) {
                        ...
                        a.nodes.forEach(function (n) {
                            ...
                            c === n ||
                                ...
                                (b =
                                    a.vectorLength(d) -
                                    (c.marker.radius + n.marker.radius + e)),
                                0 > b &&
                                    ((c.degree += 0.01),
                                    c.neighbours++,
                                    (f = a.repulsiveForce(
                                        -b / Math.sqrt(c.neighbours),
                                        a.k,
                                        c,
                                        n,
                                    ))),
                ...
                applyLimitBox: function (a) {
                    if (
                        ...
                        0 > b &&
                            b > -2 * a.marker.radius &&
                            ((a.plotX -= 0.01 * c.x), (a.plotY -= 0.01 * c.y));
                    }
                ...
                },
                {
                    ...
                    drawGraph: function () {
                        if (this.layout && this.layout.options.splitSeries) {
                            var a = this.chart,
                                b =
                                    this.layout.options.parentNodeOptions
                                        .marker;
                            b = {
                                fill:
                                    b.fillColor ||
                                    r(this.color).brighten(0.4).get(),
                    ...
                    createParentNodes: function () {
                        ...
                        a.points.forEach(function (c) {
                            a.parentNodeMass +=
                                Math.PI * Math.pow(c.marker.radius, 2);
                        });
                        ...
                        e ||
                            ...
                            a.parentNode &&
                                ((g.plotX = a.parentNode.plotX),
                                (g.plotY = a.parentNode.plotY)),
                            (a.parentNode = g),
                    ...
                    addLayout: function () {
                        ...
                        var h = b[a.type];
                        h ||
                            ((a.enableSimulation = B(e.forExport)
                                ? !e.forExport
                                : a.enableSimulation),
                    ...
                    translate: function () {
                        ...
                        if (g) var q = a.allDataPoints;
                            ...
                            ((q = this.placeBubbles(a.allDataPoints)),
                    ...
                    checkOverlap: function (a, b) {
                        ...
                        return (
                            -0.001 >
                            Math.sqrt(c * c + f * f) - Math.abs(a[2] + b[2])
                        );
                    },
                    ...
                    resizeRadius: function () {
                        ...
                        if (1e-10 < Math.abs(d - 1)) {
                            ...
                            ((a.diffY = l / 2 + h - m - (p - m) / 2),
                                (a.diffX = k / 2 + g - t - (v - t) / 2));
                    },
                    ...
                    select: function (a, b) {
                        ...
                        this.isParentNode
                            ? ((c.getSelectedPoints = c.getSelectedParentNodes),
                              ...
                              (c.getSelectedPoints =
                                  g.Chart.prototype.getSelectedPoints))
                            : h.prototype.select.apply(this, arguments);
                    },
                },
            );
        ...
        function (d, a, g, h, b, r) {
            ...
            p.toXY = function (a) {
                ...
                h &&
                    ...
                    !g.isRadialBar &&
                    (a.plotY = e =
                        "number" === typeof l ? d.translate(l) || 0 : 0);
                a.rectPlotX = f;
                a.rectPlotY = e;
                ...
                this.kdByAngle
                    ? ((b =
                          ((f / Math.PI) * 180 + c.pane.options.startAngle) %
                          360),
                      0 > b && (b += 360),
                      (a.clientX = b))
                    : (a.clientX = a.plotX);
            ...
            k.spline &&
                ...
                k.areasplinerange &&
                    (k.areasplinerange.prototype.getPointSpline =
                        k.spline.prototype.getPointSpline));
            t(
                w,
                "afterTranslate",
                function () {
            ...
            b.prototype.clipCircle = function (a, b, c, d) {
                var f = e(),
                    g = this.createElement("clipPath")
                        ...
                        .add(this.defs);
                a = d
                    ? this.arc(a, b, c, d, 0, 2 * Math.PI).add(g)
                    : this.circle(a, b, c).add(g);
                a.id = f;
                a.clipPath = g;
                return a;
            };
