...
(function (a) {
        ...
        function (a, h) {
            ...
            return {
                addClass: function (a, l) {
                    a.classList
                        ? a.classList.add(l)
                        : 0 > a.className.indexOf(l) && (a.className += l);
                },
    ...
    r(
        ...
        function (a, h) {
            function m(e) {
                if (e.points && e.points.length && e.points[0].graphic)
                    return e.points[0].graphic.element;
            }
            function n(e) {
                var d = m(e);
                return (
            ...
            return {
                getChartTitle: function (e) {
                    return l(
                        e.options.title.text ||
                            e.langFormat("accessibility.defaultChartTitle", {
                                chart: e,
                            }),
                    );
                },
                ...
                scrollToPoint: function (e) {
                    var d = e.series.xAxis,
                        b = e.series.yAxis,
                        f = (null === d || void 0 === d ? 0 : d.scrollbar)
                            ? d
                            : b;
                    if (
                        (d =
            ...
            m.prototype = {
                run: function (a) {
                    ...
                    g
                        ? (l = g[1].call(this, m, a))
                        : 9 === m &&
                          (l = this.response[a.shiftKey ? "prev" : "next"]);
                    return l;
                },
            };
            return m;
        ...
        function (a, h, q, n, p, l) {
            ...
            g.prototype = {
                        ...
                        .forEach(function (f) {
                            ...
                            d.addEvent(c, f, function (c) {
                                var f = a
                                    ...
                                    : d.cloneMouseEvent(c);
                                b &&
                                    d.fireEventOnWrappedOrUnwrappedElement(
                                        b,
                                        f,
                                    );
                                c.stopPropagation();
                ...
                cloneMouseEvent: function (b) {
                    if ("function" === typeof m.MouseEvent)
                        return new m.MouseEvent(b.type, b);
                    if (k.createEvent) {
        ...
        function (a, h, q, n) {
            ...
            m.prototype = {
                ...
                onFocus: function (d) {
                    ...
                    d =
                        d.relatedTarget &&
                        f.container.contains(d.relatedTarget);
                    this.isClickingChart ||
                        d ||
                        (null === (b = this.modules[0]) || void 0 === b
                            ? void 0
                            : b.init(1));
                },
                onMouseUp: function () {
                ...
                move: function (d) {
                    ...
                    if (
                        (b = this.modules && this.modules[this.currentModuleIx])
                    ) {
        ...
        function (a, h, q, n, p, l) {
            ...
            k(a.prototype, {
                ...
                updateLegendItemProxyVisibility: function () {
                    ...
                    (b.allItems || []).forEach(function (c) {
                        var f = c.pageIx || 0,
                            ...
                            k = c.legendItem
                                ? Math.round(c.legendItem.getBBox().height)
                                : 0;
                        f = e + k - b.pages[f] > a || f !== d - 1;
                        c.a11yProxyElement &&
                            (c.a11yProxyElement.style.visibility = f
                                ? "hidden"
                                : "visible");
                    });
                },
                ...
                updateProxiesPositions: function () {
                    for (
                        var b = 0, d = this.proxyElementsList;
                        b < d.length;
                        b++
                    ) {
                        var a = d[b];
                ...
                updateProxyPositionForItem: function (b) {
                    ...
                    c &&
                        this.updateProxyButtonPosition(c.element, c.posElement);
                },
                ...
                proxyLegendItem: function (c) {
                    if (c.legendItem && c.legendGroup) {
                        var d = this.chart.langFormat(
                                "accessibility.legend.legendItem",
                                { chart: this.chart, itemName: b(c.name) },
                            ),
                            a = c.legendGroup.div
                                ? c.legendItem
                                : c.legendGroup;
        ...
        function (a, h, q, n, p, l) {
            ...
            a.Chart.prototype.hideExportMenu = function () {
                ...
                d &&
                    ...
                    (d.forEach(function (b) {
                        if (
                            "highcharts-menu-item" === b.className &&
                            b.onmouseout
                        )
                            b.onmouseout(e("mouseout"));
                    }),
            ...
            a.Chart.prototype.highlightExportItem = function (d) {
                ...
                if (
                    ...
                    var c = !!(this.renderTo.getElementsByTagName("g")[0] || {})
                        .focus;
                    b.focus && c && b.focus();
    ...
    r(
        ...
        function (a, h, q, n, p, l, g) {
            ...
            function k(b) {
                var c =
                        b.chart.options.accessibility.keyboardNavigation
                            .seriesNavigation,
            ...
            function e(b) {
                ...
                return (
                    (b.isNull &&
                        c.keyboardNavigation.seriesNavigation.skipNullPoints) ||
                    !1 === b.visible ||
                    k(b.series)
                );
            }
            ...
            n(f.prototype, {
                    ...
                    return new p(a, {
                        keyCodeMap: [
                            ...
                            [
                                ...
                                function () {
                                    a.highlightedPoint &&
                                        a.highlightedPoint.firePointEvent(
                                            "click",
                                        );
                ...
                onKbdVertical: function (b, c) {
                    ...
                    d =
                        a.options.accessibility.keyboardNavigation
                            .seriesNavigation;
                    if (d.mode && "serialize" === d.mode)
                        return this.attemptHighlightAdjacentPoint(b, c);
                    a[
                        a.highlightedPoint &&
                        a.highlightedPoint.series.keyboardMoveVertical
            ...
            function q(a) {
                var k,
                    ...
                    f =
                        null ===
                            (e =
                                null === (k = a.options) || void 0 === k
                                    ? void 0
                                    : k.accessibility) || void 0 === e
                            ? void 0
                            : e.description;
                return f
                    ? f
    ...
    r(
        ...
        function (a, h, q, n, p) {
            ...
            function g(b) {
                var c =
                    b.chart.options.accessibility.series
            ...
            function b(b, c) {
                return b.chart.langFormat(
                    "accessibility.series." + c + "Description",
                    { name: J(b[c]), series: b },
                );
            }
            function f(b) {
                ...
                if (c.xAxis && c.xAxis.dateTime)
                    return (
                        ...
                        (d =
                            (d.dateFormatter && d.dateFormatter(b)) ||
                            d.dateFormat ||
                            c),
                ...
                (c || a) &&
                    b.points.forEach(function (b) {
                        ...
                        if (
                            ...
                            ((a = b.series && b.series.is("sunburst")),
                            (a = b.isNull && !a))
                        ) {
                            var d = b.series,
                                f = l(b);
                        ...
                        a &&
                            ...
                            c
                                ? ((f = b.series),
                                  (d =
                                      f.chart.options.accessibility.point ||
                                      {}),
                                  ...
                                  (b = F(
                                      G(
                                          (f.pointDescriptionFormatter &&
                                              ...
                                              (d.descriptionFormatter &&
                                                  d.descriptionFormatter(b)) ||
                                              t(b),
                                      ),
                                  )),
            ...
            function B(a) {
                ...
                return (
                    (c.langFormat(
                        "accessibility.series.summary." + a.type + f,
                        g,
                    ) ||
                        c.langFormat(
                            "accessibility.series.summary.default" + f,
                            g,
                        )) +
                    (e ? " " + e : "") +
                    (k("yAxis") ? " " + v : "") +
            ...
            return {
                describeSeries: function (b) {
                    ...
                    if (d) {
                        ...
                        var e = (b.options.accessibility || {})
                            .exposeAsGroupOnly;
                        (a.options3d && a.options3d.enabled && c) ||
                        !(c || f || e || g(b))
            ...
            k(h.prototype, {
                ...
                onSeriesAdded: function (b) {
                    this.chart.options.accessibility.announceNewData.enabled &&
                        ((this.dirty.hasDirty = !0),
                        (this.dirty.allSeries[b.name + b.index] = b),
                        (this.dirty.newSeries = e(this.dirty.newSeries)
                            ? void 0
                            : b));
                },
                onPointAdded: function (b) {
                    ...
                    this.chart === a &&
                        a.options.accessibility.announceNewData.enabled &&
                        (this.dirty.newPoint = e(this.dirty.newPoint)
                            ? void 0
                            : b);
                },
                            ...
                            (this.queuedAnnouncement &&
                                ...
                                (this.queuedAnnouncementTimer = setTimeout(
                                    function () {
                                        c &&
                                            c.announcer &&
                                            ((c.lastAnnouncementTime =
                                                +new Date()),
                                            c.announcer.announce(
                                                c.queuedAnnouncement.message,
                                            ),
            ...
            h(a.prototype, {
                ...
                onChartRender: function () {
                    this.chart.series.forEach(function (b) {
                        !1 !==
                            (b.options.accessibility &&
                                b.options.accessibility.enabled) && b.visible
                            ? d(b)
                            : e(b);
                    });
                },
        ...
        function (a, h, q, n, p, l) {
            ...
            g(a.prototype, {
                ...
                updateProxyOverlays: function () {
                    ...
                    b.resetZoomButton &&
                        this.recreateProxyButtonAndGroup(
                            ...
                            "resetZoomProxyGroup",
                            b.langFormat("accessibility.zoom.resetZoomButton", {
                                chart: b,
                            }),
                        );
                    b.drillUpButton &&
                ...
                onMapKbdArrow: function (b, a) {
                    var c = this.keyCodes;
                    this.chart[
                        a === c.up || a === c.down ? "yAxis" : "xAxis"
                    ][0].panStep(a === c.left || a === c.up ? -1 : 1);
                    return b.response.success;
                },
                ...
                onMapKbdClick: function (b) {
                    this.fakeClickEvent(
                        this.chart.mapNavButtons[this.focusedMapNavButtonIx]
                            .element,
                    );
                    return b.response.success;
                },
            ...
            h(a.prototype, {
                ...
                onButtonNavKbdArrowKey: function (a, e) {
                    var d = a.response,
                        ...
                        f = this.chart,
                        c =
                            f.options.accessibility.keyboardNavigation
                                .wrapAround;
        ...
        function (a, h, q, n, p, l, g) {
            function m(b) {
                return b
                    ...
                    .replace(
                        /&lt;&#x2F;(h[1-7]|p|div|ul|ol|li|a|button)&gt;/g,
                        "</$1>",
                    )
                    .replace(
            ...
            a.Chart.prototype.getTypeDescription = function (b) {
                ...
                b = b[0];
                a = this.langFormat(
                    "accessibility.seriesTypeDescriptions." + b,
                    c,
                );
                var d =
                    this.series && 2 > this.series.length
                        ? "Single"
                        : "Multiple";
                return (
                    (this.langFormat("accessibility.chartTypes." + b + d, c) ||
                        this.langFormat(
                            "accessibility.chartTypes.default" + d,
                            c,
                        )) + (a ? " " + a : "")
                );
            };
            ...
            e(h.prototype, {
                    ...
                    this.screenReaderSections = {
                        before: {
                            ...
                            buildContent: function (a) {
                                ...
                                return c
                                    ? c(a)
                                    : b.defaultBeforeChartFormatter(a);
                            },
                            insertIntoDOM: function (b, a) {
                                a.renderTo.insertBefore(
                                    b,
                                    a.renderTo.firstChild,
                                );
                            },
                ...
                updateScreenReaderSection: function (b) {
                    var a = this.chart,
                        ...
                        e = d.buildContent(a),
                        f = (d.element =
                            d.element || this.createElement("div")),
                ...
                defaultBeforeChartFormatter: function () {
                    ...
                    e = {
                        ...
                        viewTableButton: c.getCSV
                            ? this.getDataTableButtonText(k)
                            : "",
                ...
                getSonifyButtonText: function (b) {
                    ...
                    if (
                        !1 ===
                        (null === (a = c.options.sonification) || void 0 === a
                            ? void 0
                            : a.enabled)
                    )
                        return "";
                ...
                focusDataTable: function () {
                    ...
                    (b = b && b.getElementsByTagName("table")[0]) &&
                        b.focus &&
                        b.focus();
                },
                initSonifyButton: function (b) {
                    ...
                    c &&
                        ...
                        (c.onclick = function (b) {
                            var a;
                            (
                                (null === (a = d.options.accessibility) ||
                                void 0 === a
                                    ? void 0
                                    : a.screenReaderSection
                                          .onPlayAsSoundClick) || e
                            ).call(this, b, d);
                        }));
                },
                ...
                getAxisRangeDescription: function (b) {
                    ...
                    return a.accessibility &&
                        "undefined" !== typeof a.accessibility.rangeDescription
                ...
                destroy: function () {
                    var b;
                    null === (b = this.announcer) || void 0 === b
                        ? void 0
                        : b.destroy();
                },
            });
        ...
        function (a) {
            ...
            return {
                isHighContrastModeActive: function () {
                    ...
                    if (m.matchMedia && a)
                        return m.matchMedia("(-ms-high-contrast: active)")
                            .matches;
                    if (h && m.getComputedStyle) {
                        ...
                        var l = (a.currentStyle || m.getComputedStyle(a))
                            .backgroundImage;
    ...
    r(
        ...
        function (a, h, q, n) {
            ...
            function g(a) {
                a.focusBorderUpdateHooks &&
                    (Object.keys(a.focusBorderUpdateHooks).forEach(
                        function (b) {
        ...
        function (a, h, q, n, p, l, g, r, k, e, d, b, f, c, w, A, z, t, E, B) {
            ...
            m.prototype = {
                ...
                initComponents: function () {
                    ...
                    g.customComponents &&
                        v(this.components, g.customComponents);
