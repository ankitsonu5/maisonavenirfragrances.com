...
(function (factory) {
    ...
    function TimePicker(picker, settings) {
        ...
        clock.key = {
            ...
            go: function (timeChange) {
                clock.set(
                    "highlight",
                    clock.item.highlight.pick +
                        timeChange * clock.item.interval,
            ...
            .on(
                ...
                function () {
                    var $pickerHolder = picker.$root.children(),
                        $viewset = $pickerHolder.find(
                            "." + settings.klass.viewset,
                        ),
                    ...
                    if ($viewset.length) {
                        ...
                        $pickerHolder[0].scrollTop =
                            ~~$viewset.position().top -
                            $viewset[0].clientHeight * 2;
    ...
    TimePicker.prototype.create = function (type, value, options) {
        ...
        return {
            ...
            mins:
                (MINUTES_IN_HOUR + (value % MINUTES_IN_HOUR)) % MINUTES_IN_HOUR,
    ...
    TimePicker.prototype.now = function (type, value /*, options*/) {
        ...
        isBelowInterval =
            value < 0 && interval * value + nowMinutes <= -interval;
    ...
    TimePicker.prototype.measure = function (type, value, options) {
        ...
        if (!value) {
            value =
                type == "min"
                    ? [0, 0]
                    : [HOURS_IN_DAY - 1, MINUTES_IN_HOUR - 1];
        }
    ...
    TimePicker.prototype.disabled = function (timeToVerify) {
        var clock = this,
            ...
            isDisabledMatch = clock.item.disable.filter(
                function (timeToDisable) {
                    ...
                    if ($.isArray(timeToDisable) || _.isDate(timeToDisable)) {
                        return (
                            timeToVerify.pick ==
                            clock.create(timeToDisable).pick
                        );
                    }
        ...
        isDisabledMatch =
            ...
            !isDisabledMatch.filter(function (timeToDisable) {
                return (
                    ($.isArray(timeToDisable) &&
                        timeToDisable[2] == "inverted") ||
    ...
    TimePicker.prototype.formats = {
        ...
        toString: function (formatString, itemObject) {
            ...
            return clock.formats
                ...
                .map(function (label) {
                    return (
                        _.trigger(clock.formats[label], clock, [
                            0,
                            itemObject,
                        ]) || label.replace(/^!/, "")
                    );
        ...
        // Otherwise go through the times to disable.
            ...
            timesToDisable.map(function (unitToDisable) {
                ...
                for (var index = 0; index < disabledItems.length; index += 1) {
                    if (
                        clock.isTimeExact(unitToDisable, disabledItems[index])
                    ) {
                        matchFound = true;
                        break;
                    }
            ...
            _.group({
                ...
                item: function (loopedTime) {
                    ...
                    var timeMinutes = loopedTime.pick,
                        isSelected =
                            selectedObject &&
                            selectedObject.pick == timeMinutes,
                        isHighlighted =
                            highlightedObject &&
                            highlightedObject.pick == timeMinutes,
                        isDisabled =
                            disabledCollection && clock.disabled(loopedTime),
                        formattedTime = _.trigger(
                    ...
                    return [
                        _.trigger(clock.formats.toString, clock, [
                            _.trigger(settings.formatLabel, clock, [
                                loopedTime,
                            ]) || settings.format,
                            loopedTime,
                        ]),
                        (function (klasses) {
                            ...
                            if (
                                viewsetObject &&
                                viewsetObject.pick == timeMinutes
                            ) {
