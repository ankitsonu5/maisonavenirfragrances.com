    ...
    <a id="close-menu">
      <div class="group-2780">
        <div class="overlap-group-8">
          <img class="line-13" src="img/close.png" alt="Line 13">
        </div>
      </div>
    </a>
    <a href="about-us.php">
    ...
    <div class="group-2837">
      <div class="group-container-1">
        <div class="group-2225">
          <div class="group-23"><img class="path-67" src="img/path-67@1x.png" alt="Path 67"></div>
          <div class="group-25-2">
            <div class="paish social-media th-container-3">
              <img class="path-63" src="img/facebook-app-symbol.png" alt="Path 63">
              <img class="path-64" src="img/tik-tok.png" alt="Path 64">
              <img class="path-65" src="img/youtube.png" alt="Path 65">
              <img class="path-65" src="img/instagram.png" alt="Path 65">
            </div>
          </div>
          <div class="group-26"><img class="path-61" src="img/path-61@1x.png" alt="Path 61"></div>
        </div>
